...
var GridmainDesign = function() {
    debugger;
    var searchicon = "<span class='fa fa-search fa-3dicon ' ></span>";
    //var searchicon1 = "<span class='fa fa-trash ' ></span>";
    var Resicon = "<span class='fa fa-registered fa-3dicon' ></span>";
    var Oicon = "<span class='fa fa-O fa-3dicon' > </span >";
    webix.ui({
        id: "gridMain",
        container: "divGrid",
        select: 'row',
