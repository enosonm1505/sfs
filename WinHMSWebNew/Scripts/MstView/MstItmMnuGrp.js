...
var ItmMnuLoad = function (Request, ItmMnuID, Glurl) {
    //debugger;
    ...
    data: "request=" + dataparam,
        success: function (d) {
            ...
            $("#txtItmMnuNm").val(Detemp.ItmMnu[0].G_N);
            $("#txtSeqNo").val(Detemp.ItmMnu[0].S_N);
            if (Detemp.ItmMnu[0].A_IND == "" || Detemp.ItmMnu[0].A_IND == null)
...
var ItmMnuSave = function (Request, Glurl) {
    var reqobj = {};
    reqobj["COMPID"] = Request.COMPID;
    reqobj["USER_ID"] = Request.USER_ID;
    reqobj["REQ_NM"] = Request.REQ_NM;
    ...
    reqobj["FormMode"] = Request.Mode;
    //debugger;
    reqobj["ItmMnuNm"] = $("#txtItmMnuNm").val().trim();
    reqobj["SeqNo"] = $("#txtSeqNo").val().trim();
    if (Request.Mode == "OPEN")
        reqobj["ItmMnuID"] = $("#ddlItmMnu").val();
    else
        reqobj["ItmMnuID"] = $("#txtItmMnu").val().trim();
