...
var PageLoad = function () {
    ...
    webix.ui({ container: "DivPerdSel", id: "btnPerdSel", css: "webix_primary",view: "button", inputWidth: 30, width: 30, icon: 'wxi-search', type: 'icon', click: function () { fnLoadPeriodPop(); } });
...
function fnRowDblClick(RowId) {
    ...
    $.ajax({
        ...
        success: function (data) {
            //   Window1 = window.open("/GLTrans/GLTransaction?Page=2&PARTIAL=2", "PopupWindow", "width=1300,height=560,left=30,top=50");
            var PageUrl = "/GLTrans/GLTransaction?Page=2&PARTIAL=2";
