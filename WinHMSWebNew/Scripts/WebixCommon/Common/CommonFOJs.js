var SingleDropdownLoadGrid = function (DivId, Request) {
    ...
    var ddlgrid = [];
    var dataparam = {};
    var Prop_Id = '@ViewBag.COMP';// @Html.Raw(Json.Encode(ViewBag.COMP));
                ...
                if (DatavalTemp[j].RESERVE_NO == dataval[i].RESERVE_NO) {
                    ...
                    if (dataval[i].SELPAX == '1') {
                        ...
                        if (dataval[i].SELPAX == '1' && dataval[i].BLOCK_ROOM_NO != "") {
                            ...
                            blkRoomNo = dataval[i].BLOCK_ROOM_NO;
                            dataparam["Sharer"] = "N";
                            dataparam["ShrGst"] = "";
                            dataparam["ResSts"] = "1";
                            dataparam["ReqFrm"] = "C";
            ...
            if (chkbox == "1") {
                ...
                $.ajax({
                    ...
                    success: function (d) {
                        ...
                        grid = JSON.parse(d);
                        if (grid.OUTPUT == "1") {
                            Message(blkRoomNo+" Checkin Successfully", "success");
                            if (j == 0)
                                response = "1";
                            else
                                response = response + ',' + "1";
                            ...
                            if (grid.OUTPUT != "0") {
                                Message(blkRoomNo+grid.OUTPUT, "error");
                                if (j == 0)
                                    response = "1";
                                else
                                    response = response + ',' + "1";
