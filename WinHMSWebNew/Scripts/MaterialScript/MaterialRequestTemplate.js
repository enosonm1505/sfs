function PageLoadFn(COMPID) {
    ...
    var ddlId = ['ddlProperty', 'ddlStore', 'ddlUOM'];
    ...
    webix.ui({
        ...
        on: {
            onChange: function () {
                CleraGridValue();
                ListProductIdLoad(); ListProductNameLoad();
            }
        }
    });
    webix.ui({
        container: "DivNarration",
        view: "textarea",
        label: "Narration",
        id: "Narration",
        labelWidth: 120,
    ...
    webix.ui({
        container: "DivAddBtnProd",
        view: 'button',
        type: "icon",
        icon: "wxi-plus",
        id: 'RequestTemplateAdd_Btn',
        width: 80,
        css: "btn-custom",
        label: 'Add',
        align: "right",
    ...
    webix.ui({
        ...
        view: "datatable",
        id: "RequestTemplateGrid",
        name: 'RequestTemplateGrid',
        select: 'row',
        columns: [
                 {
                     header: "Prod Id", id: "PRODID", width: wid_10, css: { 'text-align': 'center ! important' },
                     editor: "text", suggest: []
                 },
                  { header: "", id: "PRODSRCHMODE", width: wid_4, template: SearchIcon, css: { 'text-align': 'center ! important', 'padding': '0px ! important' }, hidden: false, },
                 {
                     header: "Prod Name", id: "PRODNM", width: wid_35, editor: "text", css: { 'text-align': 'left ! important' },
                     editor: "text", suggest: []
                 },
                 { header: "Details", id: "DETAILS", width: wid_15, hidden: true, css: { 'word-wrap': 'break-word', 'text-align': 'left ! important' }, fillspace: true, editor: "popup", },
                 {
                     header: "UOM", id: "ProdUOM", width: wid_10, css: { 'text-align': 'center ! important' }, editor: "richselect",
                     options: types
                 },
                 { header: "MR Qty", id: "ProdMRQty", width: wid_9, editor: "text", css: { 'text-align': 'center ! important' } },
                 ...
                 { header: "Asset", id: "ASSET", width: wid_15, css: { 'text-align': 'center ! important' }, hidden: true, },
                 { header: "Asset Id", id: "ASSETID", width: wid_5, css: { 'text-align': 'center ! important' }, hidden: true, },
...
function fnresize() {
    $$("CostCenterDDL").resize();
    $$("TemplateNameTxt").resize();
    $$("TemplateNameDDL").resize();
    $$("Narration").resize();
    $$("RequestTemplateGrid").resize();
    $$("RequestTemplateAdd_Btn").enable();
    $$("ddlStore").resize();
}
function fnDisable() {
...
function gridResize(choice) {
    ...
    $$("ddlStore").adjust();
    var offsetTop = $$("RequestTemplateGrid").getNode().offsetTop;

    $$("RequestTemplateGrid").define("height", ((vheight - offsetTop - 250)));
    $$("RequestTemplateGrid").adjust();
