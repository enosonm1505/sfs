...
var PageLoad = function () {
    ...
    webix.ui({
        ...
        container: "divBtnDelCol", id: "btnDelCol", css: "webix_primary", view: "button", inputWidth: 100, label: "Del Column", click: function () {
            ...
            if (lencolumns > collen && $("#HdnDelColValue").val() == "2") {    //3
                ...
                for (j = 0; j < 10; j++) {
                    var lenval = dtAdd.length;
                    if (lenval != 0 && (dtAdd[j].ixFrom == "" || dtAdd[j].ixFrom == undefined) && dtAdd[j].ixFrom != "0") {
                        ...
                        'onAfterEditStop': function (state, editor) {
                            ...
                            if (editor.column == 'ixFrom') {
                                ...
                                if (isNaN(ixfrm)) {
                                    ...
                                    $$("dtAddColPop").refresh();
                                   // webix.message({ type: 'warning', text: 'Enter Days Only' });
                                }
                            }
                    ...
                    cols: [
                        {
                            ...
                            click: function () {
                                ...
                                $$("gridRpt").refreshColumns();
                                var set;
                                //set = { id: "ixPropId", header: { text: "PropertyId" }, hidden: true, width: 150, css: { 'text-align': 'left ! important', }, exportType: "string" };
                                //ColVal.push(set);
  
                                set = { id: "ixPropNm", header: { text: "Property" }, hidden: bMulti=="0"?true:false, width: 150, css: { 'text-align': 'left ! important', }, exportType: "string" };
                                 ColVal.push(set);

                                set = { id: "ixPartyNm", width: 280, css: { 'text-align': 'center ! important', }, exportType: "string", header: { text: "Party Name" }, };
                                ColVal.push(set);

                                set = { id: "ixBal", width: 120, css: { 'text-align': 'center ! important', }, exportType: "string", header: { text: "Balance Amt" }, };
                                ColVal.push(set);
                                ...
                                set = { id: "ixUnAdj", header: { text: "Un Adjusted", }, hidden: true, exportType: "number", exportFormat: "#,##0.00", };
                                ColVal.push(set);

                                set = { id: "ixSalPer", header: { text: "Sales Person", }, hidden: true };
                                ColVal.push(set);

                                set = { id: "ixNarration", header: { text: "Payment Note", }, hidden: true };
                                ColVal.push(set);
    ...
    webix.ui({
        ...
        columns: [
            // { id: "ixPropId", header: 'PropertyId', hidden: true },//120
                ...
                { id: "ix181", header: ' > 30', width: 120, css: { 'text-align': 'right ! important', }, exportType: "number", exportFormat: "#,##0.00", },
...
function fnLoadGrid() {
   ...
   // var dataDyDays = $("#HdnDyDays").val();
    ...
    var ReqNm = "";
    if (AcIds == "" && (vGrpIds1 == "000100010004" || vGrpIds1 == "000200040003")) ReqNm = "GET_FNGLLOADOUTSTANDSUMMCONTACCUST";
    else ReqNm = "GET_FNGLLOADOUTSTANDSUMMCUST"
