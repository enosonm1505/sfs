...
var PageLoad = function () {
    ...
    webix.ui({ container: "divBtnDisplay", id: "btnDispay", css: "webix_primary", view: "button", inputWidth: 60, label: "Display", click: function () { fnLoadGrid(); } });
...
function GridDesign() {    
    webix.ui({
        ...
        columns: [
                ...
                { id: "AC_NM", header: 'Ledger', width: 280, css: { 'text-align': 'left ! important', }, },
               
              

                 {
                     id: "TRNDR",header: 'DR Amt', width: 140, css: { 'text-align': 'right ! important', }, exportType: "number",
                     exportFormat: "#,##0.00",
                 },

                 {
                     id: "TRNCR",header: 'CR Amt', width: 140, css: { 'text-align': 'right ! important', }, exportType: "number",
                     exportFormat: "#,##0.00",
                 },

                 {
                     id: "CLOSECR",header: 'Balance', width: 140, css: { 'text-align': 'right ! important', }, exportType: "number",
                     exportFormat: "#,##0.00",
                 },
...
function fnRowDblClick(RowId) {
    ...
    $.ajax({
        ...
        success: function (data) {
            var PageUrl = "";
            if (AC_CAT == "G") {
                // Window1 = window.open("/GLTransaction/AccControl/", "PopupWindow", "width=970,height=540,left=30,top=100");
                PageUrl = "/GLTransaction/AccControl?PARTIAL=1";
            }
            else if (AC_CAT == "L") {
                
                //Window2 = window.open("/GLTransaction/LedgerDetailPop/", "PopupWindow", "width=970,height=540,left=30,top=100");
...
function loadOptionPopWindow() {
    webix.ui({
        ...
        body: {
            rows: [
                    {
                        view: "scrollview", scroll: "y", height: 250, width: 350, body: {
                                    ...
                                    cols: [
                                        {
                                            ...
                                            body: {
                                                rows: [                                                    
                                                    ...
                                                    { view: "checkbox", id: "chkOpnBal", labelWidth: 5, labelRight: "Opening Balance", customCheckbox: false, click: function () { fnChkOpenClick(); }, },
                                                    { view: "checkbox", id: "chkTrans", labelWidth: 5, labelRight: "Transaction", customCheckbox: false, click: function () { fnChkTransClick(); }, },
                                                    { view: "checkbox", id: "chkClsBal", labelWidth: 5, labelRight: "Closing Balance", customCheckbox: false, click: function () { fnChkClsClick(); }, },                                
                                                ...
                                                rows: [
                                                    {
                                                        ...
                                                        cols: [
                                                                {
                                                                    width: 130, labelWidth: 85, view: "checkbox", id: "chkLedgNm", label: "Ledger Name", customCheckbox: false, click: function () {  }

                                                                },
                                                                {
                                                                    width: 130, labelWidth: 95, view: "checkbox", id: "chkAccGrp", label: "Account Group", customCheckbox: false, click: function () {  }
                                                                },
...
function btnOkOptionClick() {
    ...
    if (CompId.indexOf(",") >= 0) {
        ...
        //}
        $("#LayoutText").text("Income Vs Expense List");
    }
    else {
        fnShowColumn();
        $("#LayoutText").text("Income Vs Expense List");
