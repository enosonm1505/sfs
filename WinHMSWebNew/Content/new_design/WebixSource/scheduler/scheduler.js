...
(function (global, factory) {
	...
	function init() {
	  ...
	  if (!config.form) {
	    config.form = [{
	      ...
	      view: "datetext",
	      label: labels.label_start,
	      labelWidth: 90,
	      id: "start_date",
	      name: "start_date",
	      dateFormat: config.form_date
	    }, {
	      view: "datetext",
	  ...
	  if (!config.bottom_toolbar) {
	    config.bottom_toolbar = [{
	      ...
	      name: "today",
	      type: "flat",
	      label: labels.icon_today,
	      inputWidth: scheduler.xy.icon_today,
	      align: "center",
	      width: scheduler.xy.icon_today + 6
	    }, {
	      view: "segmented",
	      id: "buttons",
	      value: config.mode || "week",
	      align: "center",
	      multiview: true,
	      options: [{
	        id: "day",
	        value: labels.day_tab,
	        width: scheduler.xy.day_tab
	      }, {
	        id: "week",
	        value: labels.week_tab,
	        width: scheduler.xy.week_tab
	      }, {
	        id: "month",
	        value: labels.month_tab,
	        width: scheduler.xy.month_tab
	      }]
	    }, {
	      view: "ariabutton",
	      label: labels.icon_add,
	      type: "icon",
	      icon: "wxi-plus",
	      name: "add",
	      id: "add",
	  ...
	  if (!config.selected_toolbar) {
	    config.selected_toolbar = [{
	      view: "altbutton",
	      width: scheduler.xy.icon_back,
	      type: "flat",
	      name: "back",
	      id: "back",
	      align: "center",
	      label: labels.icon_back
	    }, {
	      view: "altbutton",
	      inputWidth: scheduler.xy.icon_edit,
	      name: "edit",
	      id: "edit",
	      align: "right",
	      label: labels.icon_edit
	    }];
	  }
	  ...
	  if (!config.form_toolbar) {
	    config.form_toolbar = [{
	      view: "altbutton",
	      type: "flat",
	      width: scheduler.xy.icon_cancel,
	      name: "cancel",
	      id: "cancel",
	      align: "center",
	      label: labels.icon_cancel
	    }, {
	      view: "altbutton",
	      inputWidth: scheduler.xy.icon_save,
	      name: "save",
	      id: "save",
	      align: "right",
	      label: labels.icon_save
	    }];
	  }
	  ...
	  if (!config.date_toolbar) {
	    config.date_toolbar = [{
	      ...
	      view: "altbutton",
	      width: scheduler.xy.icon_done,
	      name: "done",
	      id: "done",
	      align: "right",
	      label: labels.icon_done
	    }];
	  }
	}
	...
	var code = function () {
	  ...
	  webix.attachEvent("onAfterSchedulerInit", function (scheduler) {
	    ...
	    scheduler._applyRecExeption = function (mode) {
	      ...
	      if (mode == "edit") {
	        ...
	        this.add(data); //this.setCursor(data.id);
	    ...
	    scheduler.repeat_date = function (ev, stack, from, to) {
	      ...
	      while (td < to && td < ev.end_date) {
	        ...
	        if (!ch) {
	          ...
	          var copy = webix.copy(ev); //copy._timed = ev._timed;
	  ...
	  webix.attachEvent("onBeforeSchedulerInit", function () {
	    ...
	    if (!config.recurring_views_list) config.recurring_views_list = [{
	      id: "none",
	      value: labels.recurring.none,
	      readonly: true
	    }, {
	      id: "daily",
	      value: labels.recurring.daily
	    }, {
	      id: "weekly",
	      value: labels.recurring.weekly
	    }, {
	      id: "monthly",
	      value: labels.recurring.monthly
	    }, {
	      id: "yearly",
	      value: labels.recurring.yearly
	    }];
	    ...
	    if (!config.rec_init_form) config.rec_init_form = [{
	      height: 10
	    }, {
	      view: "reclist",
	      id: "recList",
	      ...
	      css: "rec_list",
	      value: "none",
	      template: scheduler.templates.rec_list_item,
	      datatype: "json",
	      data: config.recurring_views_list,
	      labelWidth: 100
	    }, {
	      maxHeight: 42
	    }, {
	      ...
	      id: "endRepeat",
	      name: "endRepeat",
	      labelWidth: xy.recurring.label_end_repeat,
	      label: labels.recurring.end_repeat
	    }, {}];
	    if (!config.end_repeat_form) config.end_repeat_form = [{
	      ...
	      cols: [{
	        view: "radio",
	        css: "webix_endby_radio",
	        vertical: true,
	        id: "endBy",
	        width: 290,
	        labelWidth: xy.recurring.label_end_by,
	        height: 80,
	        options: [{
	          value: labels.recurring.endless_repeat,
	          id: "0"
	        }, {
	          value: labels.recurring.end_repeat_label,
	          id: "1"
	        }]
	      }, {}]
	    }, {
	    ...
	    if (!config.daily_form) config.daily_form = [{
	      ...
	      cols: [{
	        view: "label",
	        label: labels.recurring.every,
	        width: xy.recurring.label_every
	      }, {
	        view: "counter",
	        id: "dayCount",
	        name: "dayCount",
	    ...
	    if (!config.week_day_counters) config.week_day_counters = [{
	      id: 1,
	      value: labels.recurring.counters[0]
	    }, {
	      id: 2,
	      value: labels.recurring.counters[1]
	    }, {
	      id: 3,
	      value: labels.recurring.counters[2]
	    }, {
	      id: 4,
	      value: labels.recurring.counters[3]
	    }, {
	      id: 5,
	      value: labels.recurring.counters[4]
	    }];
	    if (!config.week_day_labels) config.week_day_labels = [{
	      id: 1,
	      value: webix.i18n.calendar.dayFull[1]
	    }, {
	      id: 2,
	      value: webix.i18n.calendar.dayFull[2]
	    }, {
	      id: 3,
	      value: webix.i18n.calendar.dayFull[3]
	    }, {
	      id: 4,
	      value: webix.i18n.calendar.dayFull[4]
	    }, {
	      id: 5,
	      value: webix.i18n.calendar.dayFull[5]
	    }, {
	      id: 6,
	      value: webix.i18n.calendar.dayFull[6]
	    }, {
	      id: 7,
	      value: webix.i18n.calendar.dayFull[0]
	    }];
	        ...
	        body: {
	          ...
	          rows: [{
	            ...
	            cols: [{
	              ...
	              name: "weekCountM",
	              css: "",
	              options: config.week_day_counters
	            }, {
	              view: "select",
	              value: 1,
	              id: "weekDayM",
	              name: "weekDayM",
	              css: "",
	              options: config.week_day_labels
	            }]
	          }, {}]
	        }
	      }]
	    ...
	    if (!config.yearly_form) config.yearly_form = [{
	      ...
	      view: "checkbox",
	      label: labels.recurring.week_day,
	      id: "typeWeekY",
	      name: "typeWeekY",
	      labelWidth: 250,
	      value: 1
	    ...
	    if (!config.recurring_views) config.recurring_views = [{
	      id: "recForm",
	      view: "form",
	      css: "webix_rec_form",
	      padding: 0,
	      scroll: false,
	      elements: config.rec_init_form
	    }, {
	      id: "endRepeatForm",
	      view: "form",
	      type: "clean",
	      elements: config.end_repeat_form
	    }, {
	      id: "daily",
	      view: "daily",
	      elements: config.daily_form,
	      elementsConfig: {
	        height: 42
	      }
	    }, {
	      ...
	      view: "weekly",
	      type: "clean",
	      elements: config.weekly_form
	    }, {
	      id: "monthly",
	      view: "monthly",
	      elements: config.monthly_form,
	      margin: 10
	    }, {
	      id: "yearly",
	      view: "yearly",
	    ...
	    webix.protoUI({
	      ...
	      defaults: {
	        ...
	        rows: [{
	          ...
	          height: 50,
	          css: "webix_subbar",
	          elements: config.recurring_bar,
	          visibleBatch: "default"
	        }, {
	          id: "recViews",
	          animate: false,
	          cells: config.recurring_views
	        }],
	        typeToId: {
	          "day": "daily",
	          "week": "weekly",
	      ...
	      _setEvents: function () {
	        ...
	        webix.delay(function () {
	          ...
	          topParent.$$("editForm").elements.endRepeat = topParent.$$("endRepeat"); // hide rec_type field in case of editing series occurrence
	...
	webix.protoUI({
	  ...
	  _toHTML: function (obj) {
	    var mark = this.data.getMark(obj.id, "webix_selected") ? " webix_selected" : ""; //check if related template exist
	...
	webix.protoUI({
	  ...
	  render: function (id, data) {
	    if (!this.isVisible(this.config.id)) return; //full reset
	...
	webix.protoUI({
	  ...
	  setValue: function (data) {
	    if (_typeof(data) == "object" && data[0] == "day") {
	...
	webix.protoUI({
	  name: "weekly",
	  setValue: function (data) {
	    if (_typeof(data) == "object" && data[0] == "week") {
	      if (!data[1] && data[1] === "") data[1] = 1;
	...
	webix.protoUI({
	  ...
	  defaults: {
	    ...
	    rows: [{
	      ...
	      name: 1,
	      id: 1,
	      labelRight: webix.i18n.calendar.dayFull[1]
	    }, {
	      view: "checkbox",
	      name: 2,
	      id: 2,
	      labelRight: webix.i18n.calendar.dayFull[2]
	    }, {
	      view: "checkbox",
	      name: 3,
	      id: 3,
	      labelRight: webix.i18n.calendar.dayFull[3]
	    }, {
	      view: "checkbox",
	      name: 4,
	      id: 4,
	      labelRight: webix.i18n.calendar.dayFull[4]
	    }, {
	      view: "checkbox",
	      name: 5,
	      id: 5,
	      labelRight: webix.i18n.calendar.dayFull[5]
	    }, {
	      view: "checkbox",
	      name: 6,
	      id: 6,
	      labelRight: webix.i18n.calendar.dayFull[6]
	    }, {
	      view: "checkbox",
	      name: 7,
	      id: 7,
	      labelRight: webix.i18n.calendar.dayFull[0]
	    }]
	  },
	  getValue: function () {
	  ...
	  setValue: function (values) {
	    ...
	    if (_typeof(values) != "object") values = values.split(",");
	...
	webix.protoUI({
	  ...
	  setValue: function (data) {
	    if (_typeof(data) == "object" && data[0] == "month") {
	      var topParent = this.getTopParentView();
	      if (!data[1] && data[1] === "") data[1] = 1;
	...
	webix.protoUI({
	  ...
	  setValue: function (data) {
	    if (_typeof(data) == "object" && data[0] == "year") {
	      var topParent = this.getTopParentView();
	      if (!data[1] && data[1] === "") data[1] = 1;
	...
	webix.protoUI({
	  ...
	  defaults: {
	    ...
	    body: {
	      type: "clean",
	      rows: [{
	        id: "webix_confirm_message",
	        template: "<div class='webix_dialog_text'>#text#</div>",
	        data: {
	...
	scheduler.locale.labels = values;
	scheduler.config = values$1;
	scheduler.xy = values$2;
	scheduler.templates = values$3;
	webix.ready(function () {
	  ...
	  var views = [{
	    ...
	    rows: [{
	      ...
	      rows: [{
	        ...
	        id: "formCalendar",
	        width: 0,
	        calendarTime: config.calendar_hour,
	        timepicker: 1,
	        hourStart: 0
	      }, {
	        view: "template",
	  ...
	  webix.protoUI({
	    ...
	    getWeekEvents: function () {
	      ...
	      var filter = null;
	      if (config.multi_day && scheduler.$$("weekEventsList").isVisible()) filter = function (ev) {
	        var dateStart = webix.Date.datePart(ev.start_date, true);
	        var dateEnd = webix.Date.datePart(ev.end_date, true);
	        return webix.Date.equal(dateStart, dateEnd) || ev.start_date.valueOf() > d.valueOf() || ev.end_date.valueOf() < next.valueOf() || ev.start_date.valueOf() <= d.valueOf() && ev.end_date.valueOf() >= next.valueOf();
	      };
	    ...
	    getTodayEvents: function () {
	      ...
	      var next = webix.Date.add(d, 1, "day", true);
	      var filter = null;
	      if (config.multi_day && scheduler.$$("dayList").isVisible()) filter = function (ev) {
	        var dateStart = webix.Date.datePart(ev.start_date, true);
	        var dateEnd = webix.Date.datePart(ev.end_date, true);
	        return webix.Date.equal(dateStart, dateEnd) || ev.start_date.valueOf() > d.valueOf() || ev.end_date.valueOf() < next.valueOf();
	      };
	    ...
	    _initStructure: function () {
	      ...
	      this._initHotKeys(); //store current date
	      ...
	      this.$$("weekEventsList").bind(this.coreData); //custom data binding for day-list
	    ...
	    _initMonth: function () {
	      ...
	      this.$$("calendar").attachEvent("onAfterZoom", webix.bind(function (zoom) {
	        ...
	        if (!zoom) this.$$("calendar").callEvent("onBeforeMonthChange", [null, this.$$("calendar").config.date]);
	      }, this));
	          ...
	          if (!this._isMonthCalendarZoomed) {
	            if (this.$$("tabViews").config.animate) {
	              webix.ui.animateView(this.$$("month").getBody(), webix.bind(function () {
	                ...
	                type: "slide",
	                direction: oldDate < date ? "left" : "right"
	              });
	            } else {
	              this.setDate(date);
	            }
	...
	code(); // #include scheduler/scheduler_recurring.js
