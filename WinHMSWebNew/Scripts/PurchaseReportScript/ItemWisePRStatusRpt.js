...
{ "id": "M5", "value": "Short Closed" },
   ...
   //var potype = fnLoadPoType();
    $scope.frmItmWiseStatsRpt = {
        id: "frmItmWiseStatsRpt",
        view: 'form',
        minWidth: 900,
        //width: 1200,
       height: 550,
               ...
               rows: [
                  {
                  ...
                  },
                   {
                                  ...
                                  columns: [
                                      { id: "vIndNo", header: "vIndNo ", width: 200, css: { 'text-align': 'center ! important' },hidden:true },
...
function fnLoadGrid() {
  ...
  //  btnOkFilterClick();
    ...
    dataparam["ReportType"] = "ItemStatus";
