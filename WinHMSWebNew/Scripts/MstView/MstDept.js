...
var DeptLoad = function (Request, DeptID, Glurl) {
    //debugger;
    ...
    data: "request=" + dataparam,
        success: function (d) {
            ...
            $("#txtDeptNm").val(Detemp.Dept[0].DEPART_NM);

            if (Detemp.Dept[0].A_IND == "" || Detemp.Dept[0].A_IND == null)
...
var DeptSave = function (Request, Glurl) {
    var reqobj = {};
    reqobj["COMPID"] = Request.COMPID;
    reqobj["USER_ID"] = Request.USER_ID;
    reqobj["REQ_NM"] = Request.REQ_NM;
    ...
    reqobj["FormMode"] = Request.Mode;
    //debugger;
    reqobj["DeptNm"] = $("#txtDeptNm").val().trim();
    if (Request.Mode == "OPEN")
        reqobj["DeptID"] = $("#ddlDept").val().trim();
    else
        reqobj["DeptID"] = $("#txtDept").val().trim();
