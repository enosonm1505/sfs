...
app.controller("GLMasterController", function ($scope) {
    ...
    $scope.frmFiscalYrRevrse = {

        id: "frmFiscalYrRevrse",
        view: 'form',
        minWidth: 1200,
        maxWidth: 5000,
        minHeight: 550,
        ...
        elements: [
            {
                rows: [
                    ...
                    },
                    {
                        ...
                        id: "lblNote",
                        stringResult: true,
                        label: "Note:-  For the reversed Fiscal Year, transactions will be accepted.",
                        labelWidth: 90,
                        inputWidth: 550,
                        width: 550,
                        css: "wc-rdtlt",
                   ...
                   //                     $("#LoadDIv").show();
                   //                     var dataparam = {};
                   //                     dataparam["REQTYPE"] = "GET_REVRSEEFISCALYEAR";
                   //                     dataparam["PROGNAME"] = "";
