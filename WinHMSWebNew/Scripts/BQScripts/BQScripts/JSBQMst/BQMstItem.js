                    ...
                    on: {
                        'onItemDblClick': function (id, e, node) {
                            ...
                            if (Filter1.length > 0) {
                                ...
                                $$("ChkActive").setValue($.trim(Filter1[0].A_IND) == "1" ? "0" : "1");
        ...
        success: function (objRes) {
            if (objRes != "") {
                ...
                if ($.trim(rowData) == "True") {
                    if ($("#hdnBNQInd").val() == "1") {
                            $("#LoadDIv").hide();
                            $("#hdnFieldId").val($.trim($$("txtItemId").getValue()));
                            $("#hdnMstType").val("BANQITEM");
...
function fnBQValidate() {
    ...
    if ($.trim($$("txtItemId").getValue()) == "") {
        AlertMessage("Item Id cannot be empty !");
        return false;
    }

    if ($.trim($$("txtItemNM").getValue()) == "") {
    ...
    if ($.trim($$("ddlGroup").getValue()) == "") {
        AlertMessage("group cannot be empty !");
        return false;
    }

    if ($.trim($$("ddlVenue").getValue()) == "") {
        AlertMessage("Venue cannot be empty !");
        return false;
    }

    if ($.trim($$("ddlAnaGroup").getValue()) == "") {
