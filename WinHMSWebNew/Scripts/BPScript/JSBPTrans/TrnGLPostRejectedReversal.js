...
app.controller("BPTransController", function ($scope) {
    ...
    $scope.frmTrnGLPostRejectedReversal = {

        id: "frmTrnGLPostRejectedReversal",
        view: 'form',
        minWidth: "auto",
        maxWidth: "auto",
        paddingX: 40,
                                  ...
                                  
                                {
                                        ...
                                        on: {
                                            onChange: function (newval, oldval) {
                                                ...
                                                if (lenval != 0) {
                                                    for (i = 0; i < lenval; i++) {
                                                        if (newval == "1") data[i].ixAppr ="1";
                                                        if (newval == "0") data[i].ixAppr = "0";
...
function fnLoadGridData() {
    ...
    var dataparam = {};
    var rowData = "";
    dataparam["REQTYPE"] = "GET_FNLOADGLPOSTREJECTEDREVERSAL";
    dataparam["PROGNAME"] = "GET_GLPOSTREJECTEDREVERSAL";
...
function fnSave() {
    ...
    dataparam["REQTYPE"] = "GET_GLPOSTREJECTEDREVERSALSAVE";
    dataparam["PROGNAME"] = "GET_GLPOSTREJECTEDREVERSAL";
