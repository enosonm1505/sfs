                                                 ...
                                                 cols: [
                                                     ...
                                                     },
                                                     {
                                                         ...
                                                         columns: [
                                                                 ...
                                                                 { header: "Date", id: "vDate", width: 100, editor: 'date', format: webix.Date.dateToStr("%d/%m/%Y"), stringResult: true, liveEdit: true, css: { 'text-align': 'left ! important' } },
                                                                 ...
                                                                 { header: "S.Tm", id: "vStm", width: 80, editor: 'text', liveEdit: true, css: { 'text-align': 'Center ! important' } },
                                                                 { header: "E.Tm", id: "vEtm", width: 80, editor: 'text', liveEdit: true, css: { 'text-align': 'Center ! important' } },
            ...
            elements: [
                {
                    ...
                    on: {
                        'onItemDblClick': function (id, e, node) {
                            ...
                            var selectedRows = this.getSelectedItem(id.row);
                            $$("txtGstName").setValue(selectedRows[0].MembNM);
    ...
    $.ajax({
        ...
        success: function (d) {
            if (d != "") {
                ...
                $$("ddlGuestTy").setValue($.trim(TblBlkData[0].GUEST_TYPE));
