...
var fnloadAdvVoucherDet = function (VouchNo) {
    debugger;
    if (VouchNo == "") return;
    var compId = $$("Property").getValue();
    var ResNo = ""; var GstTypeNm = ""; var GstNm = ""; var ResNarr = ""; var StatusInd = "";
    var TAX_C = ""; var HCD = ""; var D1_IND = ""; var SETL_MODE_ID = ""; var Amt = "0";
...
var fnMandatory = function() {
    ...
    if (mode == "OPEN") {
        if ($$("ddlAdvVoucher").getValue()=="") {
            webix.message({ type: 'warning', text: 'Voucher No. cannot be empty' });
            webix.UIManager.setFocus($$("ddlAdvVoucher"));
            return false;
        }
    }
    ...
    if (window.C_Reserve_Status == "8") {
        ...
        if (mode == "OPEN") webix.UIManager.setFocus($$("ddlAdvVoucher"));
...
var fnAdvanceSave = function () {
    ...
    var CC_E_DT = "";
    var PARTY_NM = "";
    var TRN_NO = $$("ddlAdvVoucher").getValue(); 
...
function fnCallPrint(MISC_TRN_NO) {
