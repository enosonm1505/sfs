...
function fnRowDblClick(RowId) {
    ...
    $.ajax({
        ...
        data: "COMP_ID=" + CompId + "&Division=" + Division + "&From=" + From + "&To=" + To + "&AC_ID=" + AC_ID,
        success: function (data) {
            ...
            if (AC_CAT == "G") {
                ...
                Window2 = window.open("/GLReports/GLLedgerDetailPop/", "PopupWindow", "width=1300,height=540,left=30,top=100");
            }
        }
    });    
