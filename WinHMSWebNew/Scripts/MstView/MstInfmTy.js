...
var InfmTyLoad = function (Request, InfmTyID, Glurl) {
    //debugger;
    ...
    reqobj["InfmTyID"] = InfmTyID;
    reqobj["InfmSrc"] = $("#ddlInfmSrc").val();
    ...
    data: "request=" + dataparam,
        success: function (d) {
            ...
            $("#txtInfmTyNm").val(Detemp.InfmTy[0].TY_NM);
            $("#txtSeqNo").val(Detemp.InfmTy[0].S_NO);
            if (Detemp.InfmTy[0].A_IND == "" || Detemp.InfmTy[0].A_IND == null)
...
var InfmTyIdLoad = function (Request, InfmSrc, Glurl) {
    //debugger;
    //var  JSON.parse(request);
    var reqobj = {};
    reqobj["COMPID"] = Request.COMPID;
    ...
    data: "request=" + dataparam,
        success: function (d) {
            //debugger;
            var Detemp = JSON.parse(d);
            var ddlInfmTy = $("#ddlInfmTy").data("kendoDropDownList");
            ddlInfmTy.dataSource.data(Detemp.InfmTy);
            ddlInfmTy.refresh();
...
var InfmTySave = function (Request, Glurl) {
    var reqobj = {};
    reqobj["COMPID"] = Request.COMPID;
    reqobj["USER_ID"] = Request.USER_ID;
    reqobj["REQ_NM"] = Request.REQ_NM;
    ...
    //debugger;
    reqobj["InfmSrc"] = $("#ddlInfmSrc").val()
    reqobj["InfmTyNm"] = $("#txtInfmTyNm").val().trim();
    reqobj["SeqNo"] = $("#txtSeqNo").val().trim();
    if (Request.Mode == "OPEN")
        reqobj["InfmTyID"] = $("#ddlInfmTy").val().trim();
    else
        reqobj["InfmTyID"] = $("#txtInfmTy").val().trim();
