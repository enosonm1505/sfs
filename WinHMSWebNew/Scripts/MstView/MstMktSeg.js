...
var SegLoad = function (Request, SegID, Glurl) {
    debugger;
    ...
    data: "request=" + dataparam,
        success: function (d) {
            ...
            $("#txtSegNm").val(Detemp.Seg[0].MARKET_NM);

            if (Detemp.Seg[0].A_IND == "" || Detemp.Seg[0].A_IND == null)
...
var SegSave = function (Request, Glurl) {
    var reqobj = {};
    reqobj["COMPID"] = Request.COMPID;
    reqobj["USER_ID"] = Request.USER_ID;
    reqobj["REQ_NM"] = Request.REQ_NM;
    ...
    reqobj["FormMode"] = Request.Mode;
    debugger;
    reqobj["SegNm"] = $("#txtSegNm").val().trim();
    if (Request.Mode == "OPEN")
        reqobj["SegID"] = $("#ddlSeg").val().trim();
    else
        reqobj["SegID"] = $("#txtSeg").val().trim();
