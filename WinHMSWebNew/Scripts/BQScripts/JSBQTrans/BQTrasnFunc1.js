            ...
            elements: [
                {
                    ...
                    columns: [
                            ...
                            { header: ["Start Dt", { content: "textFilter" }, ], id: "startDt", width: 85, css: { 'text-align': 'left ! important' } },
    ...
    $.ajax({
        ...
        success: function (d) {
            if (d != "") {
                ...
                $$("ddlGuestType").setValue($.trim(SelResData[0].GUEST_TYPE));
...
function fnCallDepartStore() {
    ...
    if (dtVenue.length != 0 && dtVenue.length != 0) {
        ...
        for (k = 0; k < dtVenue.length; k++) {
            var CurrRowId = dtVenue[k].RowId;
            //if ($.trim(SelRowId) == $.trim(k)) {
            if ($.trim(SelRowId) == $.trim(CurrRowId)) {
                var DepartItem = [];
                ...
                for (j = 0; j < dtDepart.length; j++) {
                    ...
                    if (dtDepart[j].hdnSessionId != "" && dtDepart[j].Departid != "" && dtDepart[j].AidsId != "") {
                        ...
                        var addrow = {
                            ...
                            DepartNm: dtDepart[j].DepartNm, hdnSessionId: dtVenue[k].vSessionId, DRowId: CurrRowId,
                        };
                ...
                var Dept = dtDeptStore.filter(function (dtDeptStore) {
                    ...
                    return dtDeptStore.DRowId == CurrRowId;
                });
                                                ...
                                                $.ajax({
                                                    ...
                                                    success: function (d) {
                                                        if (d != "") {
                                                            ...
                                                            var PrdsGrp = rowData.TBLPRODSGR;

                                                            var SetSubGrp = PrdsGrp.filter(function (PrdsGrp) {
                                                                return $.trim(PrdsGrp.PROD_GR_ID) == $.trim(newval);
                                                            });

                                                            var addrow = {
                                                                id: "00", value: "--ALL--", PROD_GR_ID:"",
                                                            };

                                                            SetSubGrp = SetSubGrp.concat(addrow);

                                                            $$("ddlProdSubgrp").define("options", SetSubGrp);
                                                            ...
                                                            if (newval != "00")
                                                                FilterProd = Prodgrp.filter(function (Prodgrp) {
                                                                    return $.trim(Prodgrp.PROD_GR_ID) == $.trim(newval);
                                                                });
                                                            else
                                                                FilterProd = Prodgrp;
                                                            ...
                                                            //if (newval != "00") {
                                                            //    FilterProd = Prodgrp.filter(function (Prodgrp) {
                                                            //        return ($$("ddlProdSubgrp").getValue() == "00" ?
                                                            //            $.trim(Prodgrp.PROD_GR_ID) == $.trim(newval) :
                                                            //            ($.trim(Prodgrp.PROD_GR_ID) == $.trim(newval) && $.trim(Prodgrp.PROD_SUB_GR_ID) == $.trim($$("ddlProdSubgrp").getValue())));
                                                            //    });
                                                ...
                                                $.ajax({
                                                    ...
                                                    success: function (d) {
                                                        if (d != "") {
                                                            ...
                                                            $$("ddlProdSubgrp1").define("options", SetSubGrp);
                ...
                if (dtItem.length != 0) {
                    ...
                    for (j = 0; j < dtItem.length; j++) {
                        ...
                        if (dtItem[j].hdnIItemId != "") {
                            ...
                            var StoreData = {
                                MItemNM: dtItem[j].MItemNM, MMenuQty: dtItem[j].MMenuQty, MMenuNarr: (dtItem[j].MMenuNarr == null ? '' : dtItem[j].MMenuNarr), MPlanNm: (dtItem[j].MPlanNm == null ? '' : dtItem[j].MPlanNm),
                                hdnIItemId: dtItem[j].hdnIItemId, hdnIVenId: item[0].hdnVenueId, hdnISessId: item[0].MSessionid, hdnIPlnId: item[0].hdnPlanId, SNo: '',
                                MMenuSeqNo: dtItem[j].MMenuSeqNo, TyName: '', OTyId: '', Rate: '', SaleRate: '', Disc: '', DiscAmt: '', GrdId: '1',
                                MRowId: grdData[k].MRowId,
                            };
                            DetStore = DetStore.concat(StoreData);
...
function fnVenueValidate() {
    ...
    if (data.length != 0) {
        ...
        for (i = 0; i < data.length; i++) {
            ...
            else if (startTime.length < 5 || startTime.includes(":") == false || startTime.substring(3, 2) != ":") {
                AlertMessage("Invalid Start Time !");
                return false;             
            }
            ...
            else if (endTime.length < 5 || endTime.includes(":") == false || endTime.substring(3,2) != ":") {
            ...
            var st1 = parseFloat(Arr[0]);
            var st2 = parseFloat(Arr[1]);
            if (parseFloat(st1) > 23 || parseFloat(st2) > 59) {
            ...
            Arr = endTime.split(":");
            var et1 = parseFloat(Arr[0]);
            var et2 = parseFloat(Arr[1]);
            if (parseFloat(et1) > 23 || parseFloat(et2) > 59) {
...
function fnFBValidate()
{
    ...
    if (grdData.length != 0) {
        ...
        for (i = 0; i < grdData.length; i++) {
            ...
            var vVenCap = (grdData[i].VenueCap == "" ? 0 : parseFloat(grdData[i].VenueCap));
        ...
        for (i = 0; i < grdData.length; i++) {
            for (j = 0; j < grdData.length; j++) {
                ...
                if (i != j) {
                    ...
                    if ($.trim(grdData[j].vSessionId) == $.trim(grdData[i].vSessionId) && ($.trim(vDate1) == $.trim(vDate2)) && $.trim(grdData[j].vVenueId) == $.trim(grdData[i].vVenueId)) {
                                     ...
                                     on: {
                                         onItemClick: function () {
                                             ...
                                             if (fnWLFillData($.trim(ResvNO))) {
                                                 ...
                                                 $$("txtResvSrc").hide();
                                                 $$("BQTabView").getTabbar().setValue("ReserveFrm");
                                                 $("#hdnOldStatus").val($.trim($$("ddlStatus").getValue()));//newly added 
                                                 $("#btnSave").click();
                ...
                if ($.trim(EMsg) != "") {
                    ...
                    if (data1.length > 0) {
                        ...
                        if ($.trim(data1[0].RM_N) != "") {
                            ...
                            var TimeFm1 = new Date('01/01/2020 ' + data1[0].RM_DTM)
                        ...
                        $$("ddlGuestType").setValue($.trim(data1[0].GUEST_TYPE));
                        ...
                        $$("ddlSalesPer").setValue($.trim(data1[0].B2_ID));

                        $$("txtNarration").setValue($.trim(data1[0].NARRATION));
                    }
...
//Company Search 
function fnCallPopExtendVenueDt(fnVenueSet,fnSessionSet)
{
    ...
    webix.ui({
        ...
        close: true,
        modal: true,
        id: "PopupExtendVenueDt",
        head: "Extend Venue Date",
        position: "center",
        minWidth: 450,
        maxWidth: 450,
        move: true,
                              ...
                              {width:280},
                                 {
                                     ...
                                     on: {
                                         onItemClick: function () {                                            
                                             fnLoadVenueExtendDt(fnVenueSet, fnSessionSet);
    ...
    var CurRows = $$("grdVenue").getSelectedItem();
    var vDate = $.trim(CurRows.vDate);
    if (vDate != "")
    {
        $$("TxtVenueDt").setValue(vDate);
        $$("TxtExtendDt").setValue(vDate);

    }

    var vVenueId = $.trim(CurRows.vVenueId);
    if (vVenueId != "") $$("CmbVenue").setValue(vVenueId);

    var vSessionId = $.trim(CurRows.vSessionId);
    if (vSessionId != "") $$("CmbSession").setValue(vSessionId);
}
function fnLoadVenueExtendDt(fnVenueSet,fnSessionSet)
{
    if ($$("CmbVenue").getValue() == "")
    {
        AlertMessage("Venue cannot be empty !");
        return false;
    }
    if ($$("CmbSession").getValue() == "") {
        AlertMessage("Session cannot be empty !");
        return false;
    }
    ...
    var dataparam = {};
    dataparam["REQTYPE"] = "GET_VENUEEXTENDDT";
    dataparam["PROGNAME"] = "GET_BQRESCODE01";
    dataparam["COMPID"] = $("#hdnCompId").val();
    dataparam["FrmDt"] = $$("TxtVenueDt").getText();
    dataparam["ToDt"] = $$("TxtExtendDt").getText();
    dataparam["VenueId"] = $$("CmbVenue").getValue();
    dataparam["SessionId"] = $$("CmbSession").getValue();
    var dsgrdVenue = $$("grdVenue").serialize();
    var GridDataSet = JSON.stringify(dsgrdVenue);
    dataparam["TBLVENUE"] = GridDataSet;
    ...
    $.ajax({
        ...
        success: function (d) {
            if (d != "") {
                var rowData = JSON.parse(d);
                if (rowData.includes("greater") == true)
                {
                    AlertMessage($.trim(rowData));
                }
                else {
                    var Venue = $$("CmbVenue").getValue();
                    var Session = $$("CmbSession").getValue();
                    var CurrData = []; var CurrDept = []; var CurrData1 = [], CurrMenu = [], CurrMenuDet = [], CurrMenuPln = [], CurrMenuAddon = [];
                    var MenuItemChk = "", FBChk = "", DeptChk = "", MenuChk = "", MenuDetChk = "", MenuPlanChk = "",MenuAddOnChk = "";
                    for (i = 0; i < rowData.length; i++) {
                        var VenueDt = rowData[i].VenueDt.trim();
                        var grdVenue = $$("grdVenue").serialize();
                        var Venlen = grdVenue.length;

                        var vDate1 = ""; var vRowId = 0;
                        var Filter1 = fnSessionSet.filter(function (fnSessionSet) {
                            return fnSessionSet.id == $.trim(Session);
                        });

                        var Filter2 = fnVenueSet.filter(function (fnVenueSet) {
                            return fnVenueSet.id == $.trim(Venue);
                        });
                        var Filter3 = grdVenue.filter(function (grdVenue) {
                            return grdVenue.vVenueId == $.trim(Venue) && grdVenue.vSessionId == $.trim(Session);
                        });
                        ...
                        if (grdVenue.length != 0) {
                            ...
                            if (vDate1 == "") {
                                vDate1 = VenueDt;
                                getval.vVenueId = Venue;
                                getval.vSessionId = Session;
                                getval.vDate = vDate1;
                                ...
                                vDate1 = VenueDt;
                                var vStm = Filter1[0]["S_T"];
                                var vEtm = Filter1[0]["E_T"];
                                var vSessionNm = Filter1[0]["value"];
                                

                                var vVenueNm = Filter2[0]["value"];
                                vRowId = parseInt(grdVenue[grdVenue.length - 1].RowId )+ 1;
                                var addrow = {
                                    RowId: vRowId, vDate: vDate1, vSessionId: Session, vSessionNm: vSessionNm, vVenueId: Venue, vVenueNm: vVenueNm, vStm: vStm, vEtm: vEtm, vChkmain: '', vChklink: '',
                                    vnExtTm: '', vChkHold: '', vHoldRes: '', vSeatId: Filter3.length > 0 ? Filter3[0]["vSeatId"] : "", vODLocID: '', vF_NO: '', vD_NO: '',
                                    vF_ind: '', vf_sno: '', vsnsTm: Filter3.length > 0 ? Filter3[0]["vsnsTm"] : "", vsnEtm: Filter3.length > 0 ? Filter3[0]["vsnEtm"] : "", vPgStm: Filter3.length > 0 ? Filter3[0]["vPgStm"] : "", vpgEtm: Filter3.length > 0 ? Filter3[0]["vpgEtm"] : "", vEventNm: Filter3.length > 0 ? Filter3[0]["vEventNm"] : "", vMvid: '',
                                };
                                $$("grdVenue").add(addrow);
                            }
                            if (i == 0)
                            {
                                ...
                                var grdDepart = $$("grdDepartShow").serialize();
                                var Deplen = grdDepart.length;
                                if (Deplen != 0) {
                                    CurrDept = grdDepart.filter(function (grdDepart) {
                                        return $.trim(grdDepart.DRowId) == $.trim(dtVenue.RowId);
                                    });
                                    if (CurrDept.length != 0) {
                                        DeptChk = "1";
                                    }
                                }
                                var grdFB = $$("grdFB").serialize();
                                var FBlen = grdFB.length;
                                if (FBlen != 0) {
                                   
                                        
                                         CurrData = grdFB.filter(function (grdFB) {
                                             return $.trim(grdFB.FRowId) == $.trim(dtVenue.RowId);
                                        });

                                        if (CurrData.length != 0) {
                                            FBChk = "1";
                                            var grdMenu = $$("grdMenu").serialize();
                                            var Menulen = grdMenu.length;
                                            if (Menulen != 0) {
                                                CurrMenu = grdMenu.filter(function (grdMenu) {
                                                    return $.trim(grdMenu.MRowId) == $.trim(dtVenue.RowId);
                                                });
                                            ...
                                            var grdPlanStore = $$("grdPlanStore").serialize();
                                            if (grdPlanStore.length != 0) {

                                                CurrMenuPln = grdPlanStore.filter(function (grdPlanStore) {
                                                    return (grdPlanStore.MRowId == $.trim(dtVenue.RowId) );
                                                });
                                                if (CurrMenuPln.length != 0) MenuPlanChk= "1";
                                            }

                                            var grdMenuDetails = $$("grdMenuDetails").serialize();
                                            if (grdMenuDetails.length != 0) {

                                               CurrMenuDet = grdMenuDetails.filter(function (grdMenuDetails) {
                                                    return (grdMenuDetails.MRowId == $.trim(dtVenue.RowId) && grdMenuDetails.GrdId == '1');
                                               });
                                               if (CurrMenuDet.length != 0) MenuDetChk = "1";

                                               CurrMenuAddon = grdMenuDetails.filter(function (grdMenuDetails) {
                                                   return (grdMenuDetails.MRowId == $.trim(dtVenue.RowId) && grdMenuDetails.GrdId == '2');
                                               });
                                               if (CurrMenuAddon.length != 0) MenuAddOnChk = "1";
                                            }
                                            

                                            //var grdItem = $$("grdItem").serialize();
                                            //var Itemlen = grdItem.length;
                                            //if (Itemlen != 0) {
                                              
                                            //    CurrData1 = grdItem.filter(function (grdItem) {
                                            //        return $.trim(grdItem.MRowId) == $.trim(dtVenue.RowId);
                                            //        });
                            ...
                            if (DeptChk == "1" && $$("ChkDep").getValue()=="1")
                            {
                                if (CurrDept.length != 0) {
                                    for (k = 0; k < CurrDept.length; k++) {
                                        var addrowd = {
                                            DRowId: vRowId, Departid: CurrDept[k].Departid, AidsId: CurrDept[k].AidsId, AidsNm: CurrDept[k].AidsNm, Qty: CurrDept[k].Qty, Narration: CurrDept[k].Narration, AidsId: CurrDept[k].AidsId, DepartNm: CurrDept[k].DepartNm, hdnSessionId: Session,
                                        };
                                        $$("grdDepartShow").add(addrowd);
                                    }
                                }

                               
                            }
                            if (FBChk == "1" &&   $$("ChkFB").getValue()=="1")
                            {
                                var addrow1 = {
                                    vFBDate: vDate1, vSessionid: Session, nVenueNm: vVenueNm, vPlanId: CurrData[0].vPlanId, hdnPlnPkgId: CurrData[0].hdnPlnPkgId, vFBRate: CurrData[0].vFBRate, vExpPax: CurrData[0].vExpPax, vActPax: CurrData[0].vActPax,
                                    VenueCap: CurrData[0].VenueCap, vFdPTm: CurrData[0].vFdPTm, vServerTm: CurrData[0].vServerTm, ChkMT: CurrData[0].ChkMT, MTTime: CurrData[0].MTTime, ChkAT: CurrData[0].ChkAT, ATTime: CurrData[0].ATTime, vVenRate: CurrData[0].vVenRate,
                                    chkTaxInd: CurrData[0].chkTaxInd, vTaxAmt: CurrData[0].chkTaxInd, ChkVentaxInd: CurrData[0].chkTaxInd, vVentaxAmt: CurrData[0].vVentaxAmt, hdnvDSV: CurrData[0].hdnvDSV, hdnVenueId: Venue, hdnfbkids: CurrData[0].hdnfbkids, hdndriver: CurrData[0].hdndriver,
                                    hdnPkgNm: CurrData[0].hdnPkgNm, FRowId: vRowId,
                                };
                                $$("grdFB").add(addrow1);

                            }
                            if ($$("ChkMenu").getValue() == "1")
                            {

                                if (MenuChk == "1") {
                                    if (CurrMenu.length != 0) {
                                        for (k = 0; k < CurrMenu.length; k++) {
                                            var addMenu = {
                                                MFBDate: vDate1 , MSessionid: Session, MVenueNm: vVenueNm, hdnVenueId: Venue, hdnPlanId: CurrMenu[0].hdnPlanId, hdnPlanNM: CurrMenu[0].hdnPlanNM, MRowId: vRowId,
                                ...
                                if( MenuDetChk=="1")
                                {
                                    if (CurrMenuDet.length != 0) {
                                        for (k = 0; k < CurrMenuDet.length; k++) {
                                            var addMenuDet = {
                                                MItemNM: CurrMenuDet[k].MItemNM, MMenuQty: CurrMenuDet[k].MMenuQty, MMenuNarr: (CurrMenuDet[k].MMenuNarr == null ? '' : CurrMenuDet[k].MMenuNarr), MPlanNm: (CurrMenuDet[k].MPlanNm == null ? '' : CurrMenuDet[k].MPlanNm),
                                                hdnIItemId: CurrMenuDet[k].hdnIItemId, hdnIVenId: Venue, hdnISessId: Session, hdnIPlnId: CurrMenuDet[k].hdnIPlnId, SNo:  CurrMenuDet[k].SNo,
                                                MMenuSeqNo: CurrMenuDet[k].MMenuSeqNo, TyName: CurrMenuDet[k].TyName, OTyId: CurrMenuDet[k].OTyId, Rate: CurrMenuDet[k].Rate, SaleRate: CurrMenuDet[k].SaleRate, Disc: CurrMenuDet[k].Disc, DiscAmt: CurrMenuDet[k].DiscAmt, GrdId: '1',
                                                MRowId: vRowId,
                                            };
                                            $$("grdMenuDetails").add(addMenuDet);
                                ...
                                if (MenuAddOnChk == "1") {
                                    if (CurrMenuAddon.length != 0) {
                                        for (k = 0; k < CurrMenuAddon.length; k++) {
                                            var addMenuAddon = {
                                                MItemNM: CurrMenuAddon[k].MItemNM, MMenuQty: CurrMenuAddon[k].MMenuQty, MMenuNarr: (CurrMenuAddon[k].MMenuNarr == null ? '' : CurrMenuAddon[k].MMenuNarr), MPlanNm: (CurrMenuAddon[k].MPlanNm == null ? '' : CurrMenuAddon[k].MPlanNm),
                                                hdnIItemId: CurrMenuAddon[k].hdnIItemId, hdnIVenId: Venue, hdnISessId: Session, hdnIPlnId: CurrMenuAddon[k].hdnIPlnId, SNo: CurrMenuAddon[k].SNo,
                                                MMenuSeqNo: CurrMenuAddon[k].MMenuSeqNo, TyName: CurrMenuAddon[k].TyName, OTyId: CurrMenuAddon[k].OTyId, Rate: CurrMenuAddon[k].Rate, SaleRate: CurrMenuAddon[k].SaleRate, Disc: CurrMenuAddon[k].Disc, DiscAmt: CurrMenuAddon[k].DiscAmt, GrdId: '2',
                                                MRowId: vRowId,
                                            };
                                            $$("grdMenuDetails").add(addMenuAddon);
                                ...
                                if(MenuPlanChk=="1")
                                {
                                    if (CurrMenuPln.length != 0) {
                                        for (k = 0; k < CurrMenuPln.length; k++) {
                                            var addMenuPlan = {
                                                ITEM_NM: CurrMenuPln[k].ITEM_NM, QTY: CurrMenuPln[k].QTY, hdnPVenId: Venue, hdnPSessId: Session,
                                                hdnPPlnId: CurrMenuPln[k].hdnPPlnId, MRowId: vRowId,
                                            };
                                            $$("grdPlanStore").add(addMenuPlan);
                                        }
                                    }
                                ...
                                //{
                                //    if (CurrData1.length != 0) {
                                //        for (k = 0; k < CurrData1.length; k++) {
                                //            var addrow2 = {
                                //                MItemNM: CurrData1[k].MItemNM, MMenuQty: CurrData1[k].MMenuQty, MMenuNarr: CurrData1[k].MMenuNarr, MMenuSeqNo: CurrData1[k].MMenuSeqNo, MPlanNm: CurrData1[k].MPlanNm, hdnIItemId: CurrData1[k].hdnIItemId, hdnIVenId: Venue, hdnmSessId: Session, hdnIPlnId: CurrData1[k].hdnIPlnId, MRowId: vRowId,
                                //            };
                                //            $$("grdItem").add(addrow2);
                                //        }
                                //    }
                            ...
                            $$("txtFrmDate").setValue(vDate1);
                            $$("txtToDt").setValue(vDate1);


                        }

                    }
                    if (DeptChk == "1" && $$("ChkDep").getValue() == "1") fnCallDepartStore();
                }
            ...
            elements: [
                {
                    rows:[
                            ...
                            cols: [
                                {
                                    ...
                                    labelWidth: 55,
                                    width: 100,
                                    hidden: ($$("ddlGuestType").getValue() == "G" ? false : true),
                                    value:"1",
                                    on: {
                                        "onChange": function () {
                        ...
                        },
                        {
                            ...
                            columns: [
                                    { header: "GuestId", id: "GuestId", hidden: true },
                                    { header: [($("#hdnGstNmInd").val() == "0" ? "" : "Company id"), { content: "textFilter" }], hidden: ($$("ddlGuestType").getValue() == "G" ? true : false), id: "GuestId", width: 100, css: { 'text-align': 'left ! important' } },
                                    { header: [($$("ddlGuestType").getValue() == "G" ? "Last Name" : "Company Name"), { content: "textFilter" }], id: "GuestNm", width: ($$("ddlGuestType").getValue() == "C" ? 350 : 200), css: { 'text-align': 'left ! important' } },
                                    { header: ["First Name", { content: "textFilter" }], id: "GuestNmF", hidden: ($$("ddlGuestType").getValue() == "C" ? true : false), width: ($$("ddlGuestType").getValue() == "C" ? 130 : 250), css: { 'text-align': 'left ! important' } },
                            ...
                            on: {
                                'onItemDblClick': function (id, e, node) {
                                    ...
                                    dataparam["GuestId"] = $("#hdnGstId").val();
                                    dataparam["GuestTy"] = $.trim($$("ddlGuestType").getValue());
