...
function GridDesign() {
    webix.ui({
        ...
        columns: [
                ...
                { id: "ixTrnTy", header: 'Trn Type', width: 90, css: { 'text-align': 'center ! important', }, exportType: "string" },
                { id: "ixTrnNo", header: "Trn No.",  width: 90, css: { 'text-align': 'left ! important', }, exportType: "string",  },
                { id: "ixTrnDt", header: 'Trn Dt', width: 90, css: { 'text-align': 'center ! important', }, },
                ...
                { id: "ixRefNo", header: { text: "Doc No.", }, width: 90, css: { 'text-align': 'left ! important', }, exportType: "string" },
                { id: "ixRefDt", header: 'Doc Dt', width: 90, exportType: "string" },

                { id: "ixDueDt", header: 'Due Dt', width: 90, css: { 'text-align': 'center ! important', }, },
                { id: "ixBillDt", header: 'Ref Dt', width: 90, css: { 'text-align': 'center ! important', }, },
                { id: "ixDetails", header: 'Details', width: 250, exportType: "string" },

                { id: "ixDR", header: 'Debit Amt', width: 120, css: { 'text-align': 'right ! important', }, exportType: "number", exportFormat: "#,##0.00", },
                { id: "ixCR", header: "Credit Amt", width: 120, css: { 'text-align': 'right ! important', }, exportType: "number", exportFormat: "#,##0.00", },
                { id: "ixOut", header: 'Outstanding', width: 120, css: { 'text-align': 'right ! important', }, exportType: "number", exportFormat: "#,##0.00", },
            ...
            $export: function (obj) {
                ...
                if (item.CLR != "ExcelHead") {
                    if (vAmt != null && vAmt != undefined) {
                        ...
                        vAmt1 = vAmt1.replace(",", ""); vAmt1 = vAmt1.replace(",", ""); vAmt1 = vAmt1.replace(CrStr, ""); vAmt1 = vAmt1.replace(DrStr, "");
...
function fnRowDblClick(RowId) {
    ...
    if (TRN_ID != "" && TRN_ID != null) {
        if (TRN_ID_SRNO != "" && TRN_ID_SRNO != null) {
            ...
            //Window1 = window.open("/GLTransaction/GlReversalEntry/?RPage=" + "1" + "&PARTIAL=" + "1" + "&ID=" + UrlQryStr + "", "DayBookOpenBillRef", "width=" + SW + ",height=" + Sh + ",left=50,top=20 ");
            var PageUrl = "/GLTransaction/GlReversalEntry/?RPage=" + "1" + "&PARTIAL=" + "1" + "&ID=" + UrlQryStr + "";
    ...
    webix.ui({
        ...
        body: {
            ...
            rows: [
                    ...
                    { view: "checkbox", width: 400, labelWidth: 120, id: "chkPendBills", labelRight: "Pending Bills", customCheckbox: false, click: function () { } },
                    ...
                    { view: "text", id: "txtSuppress", hidden: true, },
...
function fnLoadGrid() {
    ...
    var ReqNm = "";
    ReqNm = "GET_FNGLLOADPARTYBILLSANDSETTLE"
