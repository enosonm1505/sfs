...
var PageLoad = function () {
    ...
    webix.ui({ container: "divPropbox", inputwidth: 250, width: 250, view: "richselect", id: "Property", on: { onChange: function (newVal, OldVal) { fnPropChange(newVal); } } });
    webix.ui({
    ...
    webix.ui({
        ...
        body: {
            ...
            rows: [
                    ...
                    { cols: [{}, { view: "button", align: 'center', maxWidth: 80, id: "OkFilter", css: 'webix-primary', label: "OK", inputWidth: 80, width: 80, click: function () { btnOkFilterClick(); } }], },
    ...
    webix.ui({
        ...
        body: {
            rows: [
                    ...
                    { cols: [{}, { view: "button", align: 'center', id: "Okoptions", icss: 'webix-primary', label: "OK", inputWidth: 80, width: 80, click: function () { btnOkOptionClick(); } }], }
            ]
