...
app.controller("ARTransController", function ($scope) {
  ...
  { "id": "2031", "value": "2031" }];
    ...
    $scope.grdARTrans = {
        ...
        height: 180,
        columns: [
                { header: "Type", id: "TrnTyId", width: 95, css: { 'text-align': 'center ! important' }, editor: "select", liveEdit: true, collection: function (id) { return ddlTypeData; } },
               { header: "Ref Nm", id: "RefNM", width:140 , editor: 'text', liveEdit: true, css: { 'text-align': 'left ! important' } },
               { header: "Due.Date", id: "DueDt", width: 80, css: { 'text-align': 'left ! important' }, editor: 'date', stringResult: true,  format: webix.Date.dateToStr("%d/%m/%Y"),  },
    ...
    function fnTrnTypeLoad(TrnTyIds) {
        ...
        dataparam["COMPID"] = $.trim($("#hdnCompId").val());
