        ...
        success: function (objRes) {
            if (objRes != "") {
                ...
                if ($.trim(rowData) == "True") {
                    ...
                    if ($("#hdnBNQInd").val() == "1") {
                        $("#LoadDIv").hide();
                        $("#hdnFieldId").val($.trim($$("txtGroupId").getValue()));
                        $("#hdnMstType").val("ANALYSISGRP");
...
function fnBQValidate() {
    ...
    if ($.trim($$("txtGroupId").getValue()) == "") {
        AlertMessage("group Id cannot be empty !");
        return false;
    }

    if ($.trim($$("txtGroupNM").getValue()) == "") {
                    ...
                    on: {
                        'onItemDblClick': function (id, e, node) {
                            ...
                            if (Filter1.length > 0) {
                                ...
                                $$("ChkActive").setValue((Filter1[0].A_IND == null || Filter1[0].A_IND == "") ? "1" : "0");
                            }
