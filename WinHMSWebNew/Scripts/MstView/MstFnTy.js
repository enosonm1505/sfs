...
var FnTyLoad = function (Request, FnTyID, Glurl) {
    //debugger;
   ...
   // // 
    ...
    $.ajax({
        ...
        success: function (d) {
            ...
            $("#txtFnTyNm").val(Detemp.FnTy[0].FUNCTION_NM);

            if (Detemp.FnTy[0].A_IND == "" || Detemp.FnTy[0].A_IND == null)
...
var FnTySave = function (Request, Glurl) {
    var reqobj = {};
    reqobj["COMPID"] = Request.COMPID;
    reqobj["USER_ID"] = Request.USER_ID;
    reqobj["REQ_NM"] = Request.REQ_NM;
    ...
    reqobj["FormMode"] = Request.Mode;
    //debugger;
    reqobj["FnTyNm"] = $("#txtFnTyNm").val().trim();
    if (Request.Mode == "OPEN")
        reqobj["FnTyID"] = $("#ddlFnTy").val().trim();
    else
        reqobj["FnTyID"] = $("#txtFnTy").val().trim();
