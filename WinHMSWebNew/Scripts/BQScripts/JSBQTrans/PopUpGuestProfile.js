...
function fnCallGuestProfile(Compid, GstTy, GuestId, Title, FirstNm, LastNM, GstNm_Ind) {
    ...
    var lBLPAN = ""; var InGstInd = ""; var K_Tax_ind = ""; var M_Tax_ind = ""; var IN_GST_SUP_IND = "";

    var TAX_CAPTION="";

    var SetDt = fnMstCompany();

    if (SetDt.length > 0)
    {
        InGstInd = (SetDt[0].IN_GST_IND == null || SetDt[0].IN_GST_IND == "" ? 0 : parseInt(SetDt[0].IN_GST_IND));

        K_Tax_ind = (SetDt[0].K_TAX == null || SetDt[0].K_TAX == "" ? 0 : parseInt(SetDt[0].K_TAX));

        M_Tax_ind = (SetDt[0].M_TAX == null || SetDt[0].M_TAX == "" ? 0 : parseInt(SetDt[0].M_TAX));

        lBLPAN = SetDt[0].ST_NAR;

        IN_GST_SUP_IND = (SetDt[0].IN_GST_SUP_IND == null || SetDt[0].IN_GST_SUP_IND == "" ? 0 : parseInt(SetDt[0].IN_GST_SUP_IND));

        TAX_CAPTION = (SetDt[0].A5_ID != null ? SetDt[0].A5_ID : "");
    }
                    ...
                    rows: [
                        ...
                        },
                        {
                            ...
                            cells: [
                              ...
                              {
                                  header: "<span class='fa fa-user'></span> Personal",
                                  body: {
                                      id: "Personal",
                                      view: "form",
                                      height:400,
                                              ...
                                              rows: [
                                                     {
                                                         ...
                                                         id: "txtGstGSTNo",
                                                         labelAlign: "Left",
                                                         label: (K_Tax_ind == 3 || M_Tax_ind == 2 ? "Guest " + TAX_CAPTION + " No." : "Guest GSTIN No"),
                                                         labelWidth: 165,
                                                         inputWidth: 400,
                                                         width: 400,
                                                         minWidth: 400,
                                                         hidden: ((InGstInd == 1 && IN_GST_SUP_IND == 0) || K_Tax_ind == 3 || M_Tax_ind == 2 ? false : true),
                                                     ...
                                                     },
                                                     {
                                                         ...
                                                         id: "txtPanNo",
                                                         labelAlign: "Left",
                                                         label: (lBLPAN == null || $.trim(lBLPAN) == "" ? " Pan No" : lBLPAN),
                                                         labelWidth: 165,
                                                         inputWidth: 400,
                                                         width: 400,
                                                         minWidth: 400,
            ...
            success: function (d) {
                if (d != "") {
                    ...
                    if (rowData.length > 0) {
                        ...
                        $$("txtGstGSTNo").setValue(rowData[0].TX_RG_NO);

                        $$("txtPanNo").setValue(rowData[0].HPL);
                    }
                }
            }
        });
...
function fnSaveGuestProf(CompId, GuestId, GstNm_Ind) {
    ...
    dataparam["txtGstGSTNo"] = $.trim($$("txtGstGSTNo").getValue());
    dataparam["txtPanNo"] = $.trim($$("txtPanNo").getValue());
