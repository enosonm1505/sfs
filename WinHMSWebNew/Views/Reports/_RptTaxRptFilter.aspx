 ...
 <% Html.Kendo().Window().Name("LocalSearch")
    ...
    .Content(() =>
        ...
        .Columns(columns =>
        {
            ...
            columns.Bound(x => x.TAX_SHRT_NM).Width(100).Title("Tax").HeaderHtmlAttributes(new { style = "text-align:center" }).Filterable(ftb => ftb.Cell(cell => cell.Operator("contains").ShowOperators(false)));
        ...
        .HtmlAttributes(new { style = "text-align:center; height:0px;" }).HeaderHtmlAttributes(new { Style = "text-align:center;" });
            ...
            columns.Bound(x => x.Select1).Hidden();              
                ...
                .Read(read => read.Action("TaxReportPop", "Reports"))
                .PageSize(500)
