function RoutingPopUpShowFn(Res_no, RNo, GId, GNm1, GNm2, stDt, enDt, Comp, Trv, PID, TrvID, SrcID, SrcNm, indx, Routprv, RmTy, Title, Mode, ConString, UsrId, CompId, usrTyId) {
    ...
    $$("RoutingPopUp").show();
   var split= SplitPopupLoadFn(Res_no, RNo, GId, GNm1, GNm2, stDt, enDt, Comp, Trv, PID, TrvID, SrcID, SrcNm, indx, Routprv, RmTy, Title, Mode, ConString, UsrId, CompId, usrTyId);
}
