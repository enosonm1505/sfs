...
function selected(cal, date) {
    ...
    if (cal.dateClicked && (cal.sel.id == "sel1" || cal.sel.id == "txtToDate")) {
        ...
        //btn.click();
        document.getElementById('hdnToDt').value = date;
        document.getElementById('hdnFromDt').value = document.getElementById('txtFDate').value;
        closeHandler(cal);
    }
        ...
        if (cal.dateClicked && (cal.sel.id == "sel1" || cal.sel.id == "txtFDate")) {
            ...
            //var btn = document.getElementById('btnExport');
            //btn.click();
            document.getElementById('hdnFromDt').value = date;
            document.getElementById('hdnToDt').value = document.getElementById('txtToDate').value;
            closeHandler(cal);
        }
   }
