...
app.controller("SalesandMarketController", function ($scope) {
...
function fnLoadVenueBook() {
    ...
    dataparam["PROPID"] = $("#hdnPropId").val();
    
    dataparam["Date"] = $("#hdnFromDt").val();
    var DataVal = JSON.stringify(dataparam);
    $.ajax({
        async: false,
        url: "/SalesAndMarket/APIWCFDIRECT_CALL",
        type: 'POST',
...
function fnVenBookDesign() {
    ...
    webix.ui({
       ...
       // height: 500,
        ...
        { id: "VenueNM", header: "Venue", width: 120, stringResult: true, css: { 'text-align': 'Left ! important' }, },
        ...
        { id: "Col37", header: [{ text: "00", colspan: 2, css: "hrowHead3" }], width: 26, css: { 'text-align': 'Center ! important' } },
        { id: "Col38", header: "38", width: 26, css: { 'text-align': 'Left ! important' } },
        { id: "Col39", header: [{ text: "01", colspan: 2, css: "hrowHead3" }], width: 26, css: { 'text-align': 'Center ! important' } },
        { id: "Col40", header: "40", width: 26, css: { 'text-align': 'Left ! important' } },

        { id: "Col41", header: [{ text: "02", colspan: 2, css: "hrowHead3" }], width: 26, css: { 'text-align': 'Center ! important' } },
        { id: "Col42", header: "42", width: 26, css: { 'text-align': 'Left ! important' } },
        { id: "Col43", header: [{ text: "03", colspan: 2, css: "hrowHead3" }], width: 26, css: { 'text-align': 'Center ! important' } },
        { id: "Col44", header: "44", width: 26, css: { 'text-align': 'Left ! important' } },
        { id: "Col45", header: [{ text: "04", colspan: 2, css: "hrowHead3" }], width: 26, css: { 'text-align': 'Center ! important' } },
        { id: "Col46", header: "46", width: 26, css: { 'text-align': 'Left ! important' } },
        ],
                                ...
                                if (i == DispRNo) {
                                    ...
                                    if ($.trim(BlockTy) == "R" || $.trim(BlockTy) == "2" || $.trim(BlockTy) == "FP") {
                                        ...
                                        if(NextERow==3)
                                        {
                                            ...
                                            var rowid = $$("grdvenueBook").getIdByIndex(i + 3);
                                            $$("grdvenueBook").addSpan(rowid, FrmCol, parseInt(ToColCount), 1, GuestDet[j].Caption5, "MBlock");
                                        }
                                        else if (NextERow == 2) {
                                            var rowid = $$("grdvenueBook").getIdByIndex(i + 1);
                                            $$("grdvenueBook").addSpan(rowid, FrmCol, parseInt(ToColCount), 1, GuestDet[j].Caption3, "MBlock");
...
function gridResize() {
    ...
    var offset = $("#frmVenueBook").offset();

    $$("grdvenueBook").define("height", ((vheight - offset.top - 40)));
    $$("grdvenueBook").adjust();
