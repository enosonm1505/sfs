...
var ClearControls = function(){
    ...
    $$("txtBillDt").setValue(""); $$("txtBillAmt").setValue(""); $$("txtPaidOut").setValue(""); $$("txtReason").setValue("");
...
var PageLoad = function () {
    ...
    webix.ui({ container: "divRetReas", view: "textarea", id: "txtReason", labelWidth: 70, label: "Reason", attributes: { maxlength: 120 }, });

    webix.ui({ view: "text", id: "txtSetlNo", labelWidth: 70, hidden:true});
    ...
    webix.ui({
        ...
        cols: [
            {
                view: "search", label: "Bill Date", labelWidth: 70, name: "BillDt", id: "txtBillDt", icon: "wxi-angle-up", readonly: true,maxWidth:250,
                on: {
                    onSearchIconClick: function () {
                        debugger;
    ...
    webix.ui({
        ...
        {view: "fieldset", label: "CreditCard", width: 400, id: "fmCreditCard",  body: {
            rows: [
                ...
                {
                    view: "text", id: "txtCC_CardNo", label: "Card No.", labelWidth: 100, attributes: { maxlength: 16 }, width: 300, on: {
                        onChange: function () {
                            if (OnClearSet == "0") fnStoreToSpread(Md_CC);
                        },
                    }
                ...
                {
                    view: "text", id: "txtCCAuthNo", label: "Approval Code", labelWidth: 100, attributes: { maxlength: 10 }, width: 300, on: {
                        onChange: function () {
                            if (OnClearSet == "0") fnStoreToSpread(Md_CC);
                        },
                    }
        ...
        {view: "fieldset", label: "Cheque", width: 400, id: "fmCheque",  body: {
            rows: [
                ...
                {
                    cols: [{
                        view: "text", id: "txtCrCurrEq", label: "Forign Amt",format: "11.00",inputAlign: "right",attributes: { maxlength: 12 }, labelWidth: 100, width: 200, on: {
                            onChange: function () {
                                debugger;                                
                                if (OnClearSet == "0") fnStoreToSpread(Md_Chq);
                            },
                        ...
                        view: "text", id: "txtconvrt", label: "Conv.Rate",format: "11.00",inputAlign: "right",readonly:true, labelWidth: 100, width: 200, on: {
                            onChange: function () {
                                if (OnClearSet == "0") fnStoreToSpread(Md_Chq);
                            },
                        }
...
var GridDesign = function () {
    ...
    webix.ui({
        ...
        columns: [
                ...
                {
                    id: "ixAmt", header: 'Amount',  width: 120, css: { 'text-align': 'right ! important;', }, editor: "text", liveEdit: true, 
                ...
                {
                    id: "ixTips", header: 'Tips', width: 90, css: { 'text-align': 'right ! important;', }, editor: "text", liveEdit: true,
                    format: function (value) {
                        return fnCurrFormat(value);
                    },
                    editParse: function (value) {
...
var fnBillSrchBtnClick = function (RowId) {
    ...
    var vData = BillSrchLoadData(vCompId,ACC_DT,"2");
    $$("BillSrchPop").show();
...
var fnClearCont = function () {
    ...
    $$("txtPANNo").setValue(""); $$("txtPANNo").hide(); $$("ChkCloseRes").setValue(0); $$("txtSetlNo").setValue(""); $$("txtReason").setValue("");
    //$$("txtBillInstr").setValue("");
    ...
    var col = $$("gridSettle").getColumnConfig("ixModeCombo");
    var SettleModes = $$("gridSettleMode").serialize();
    col.collection = SettleModes;
...
var fnloadBillDet = function (R_DummyBill_No, R_OrigBill_No, R_Guest_Nm, R_Guest_Type, R_Guest_Id, R_Reserve_No, R_ResBlk_Ind) {
    ...
    if (R_OrigBill_No != "") {
        ...
        debugger;
        fnLoadSettleInfo(R_OrigBill_No);
        chkFinalBill = "0";        
        if(fnCheckTempFolioSettlement(R_OrigBill_No)==false){
            document.getElementById("btnSettle").disabled = true;
        }
        if (fnIsRoomGuestChkdOut(R_OrigBill_No, window.BN_OUTLET_ID) == true) {
...
var fnLoadSettleInfo = function (BILL_NO) {
    debugger;
    $$("gridSettle").clearAll();    
    CompId = $$("Property").getValue();
    
    Request = {
        REQ_NM: "FNLOADSETTLEINFO",
        COMPID: CompId,
        BILL_NO: BILL_NO,
        Usr_log_ind: window.Usr_log_ind
    }
    var rowData = [];
    var Rows = [];
    requestData = JSON.stringify(Request);
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data != "") {
                rowData = JSON.parse(data);
                if (rowData.length > 0) {
                    $$("txtSetlNo").setValue(rowData[0].SETL_NO);
                    $.each(rowData, function (key, value) {
                        debugger;
                        var set = {};
                        var T_Party_Ty_Id = ""; var T_Rev_Id = "";var T_Mode_Id = "";var T_Party_Id = "";
                        var T_Room_No = ""; var T_Cheque_No = "";var T_Setl_Amt = ""; var T_Tips_Amt = "";
                        var T_Trns_RoomNo = "";var T_Trns_RegNo=""; var T_Extr_Amt = "";var T_Trns_RegNo="";
                        var T_Cur_Id ="";var T_Forn_Amt="";var T_Conv_Rate="";var T_CC_Ind = "";
                        var T_VouchNo = ""; var T_Narr = ""; var T_Party_Nm = ""; var T_Bank_Nm = "";
                        
                        var bVal = false;
                        if (value.SETL_MODE_ID) T_Mode_Id = value.SETL_MODE_ID.toString().trim();
                        if (value.REVENUE_ID) T_Rev_Id = value.REVENUE_ID.toString().trim();
                        if (value.SETL_AMT) T_Setl_Amt = value.SETL_AMT.toString().trim();
                        if (value.TIPS_AMT) T_Tips_Amt = value.TIPS_AMT.toString().trim();
                        if (T_Setl_Amt == "") T_Setl_Amt = 0;
                        if (T_Tips_Amt == "") T_Tips_Amt = 0;
                        if (T_Tips_Amt == 0) T_Tips_Amt = "";

                        switch (T_Mode_Id) {
                            case Md_Cash:                                
                                if (value.VOUCH_NO) T_VouchNo = value.VOUCH_NO.toString().trim();
                                if (value.NARRATION) T_Narr = value.NARRATION.toString().trim();
                                
                                set = {
                                    ixModeCombo: T_Mode_Id, ixAmt: T_Setl_Amt, ixTips: T_Tips_Amt, ixRevId: T_Rev_Id, ixExtrAmt: "", ixPartyTyId: "", ixPartyId: "",
                                    ixRoomNo: "", ixChqNo: "", ixBankNm: "", ixVouchNo: T_VouchNo, ixNarr: T_Narr, ixTrnsRoom: "", ixTrnsReg: "", ixcurid: "",ixcashcard:"",
                                    ixFornAmt: "", ixConvRate: "", ixCCInd: "", ixPartyNm: "", ixSetlModeId: T_Mode_Id, ixCurno: "", ixcashcardnm: "", ixNarr1: "",
                                };
                                break;
                            case Md_CashCard:                                
                                if (value.BANK_NM) T_Bank_Nm = value.BANK_NM.toString().trim();
                                if (value.CC_CHQ_NO) T_Cheque_No = value.CC_CHQ_NO.toString().trim();                               

                                set = {
                                    ixModeCombo: T_Mode_Id, ixAmt: T_Setl_Amt, ixTips: T_Tips_Amt, ixRevId: T_Rev_Id, ixExtrAmt: "", ixPartyTyId: "", ixPartyId: "",
                                    ixRoomNo: "", ixChqNo: "", ixBankNm: "", ixVouchNo: "", ixNarr: "", ixTrnsRoom: "", ixTrnsReg: "", ixcurid: "",ixcashcard:T_Cheque_No,
                                    ixFornAmt: "", ixConvRate: "", ixCCInd: "", ixPartyNm: "", ixSetlModeId: T_Mode_Id, ixCurno: "", ixcashcardnm: T_Bank_Nm, ixNarr1: "",
                                };
                                break;
                            case Md_Comp:
                                if (value.PARTY_ID) T_Party_Id = value.PARTY_ID.toString().trim();
                                if (value.NARRATION) T_Narr = value.NARRATION.toString().trim();
                                if (value.PARTYNM) T_Party_Nm = value.PARTYNM.toString().trim();

                                set = {
                                    ixModeCombo: T_Mode_Id, ixAmt: T_Setl_Amt, ixTips: T_Tips_Amt, ixRevId: T_Rev_Id, ixExtrAmt: "", ixPartyTyId: "C", ixPartyId: T_Party_Id,
                                    ixRoomNo: "", ixChqNo: "", ixBankNm: "", ixVouchNo: "", ixNarr: T_Narr, ixTrnsRoom: "", ixTrnsReg: "", ixcurid: "", ixcashcard: "",
                                    ixFornAmt: "", ixConvRate: "", ixCCInd: "", ixPartyNm: T_Party_Nm, ixSetlModeId: T_Mode_Id, ixCurno: "", ixcashcardnm: "", ixNarr1: "",
                                };
                                break;
                            case Md_CC:
                                ...
                                if (T_Narr.length >= 10)
                                {
                                    var vDate = T_Narr.substring(0, 10);
                                    if (isValidDate(vDate) == true) {
                                        vDate = formatDate1(vDate);
                                        vDate = new Date(vDate);
                                    }

                                }
                                set = {
                                    ixModeCombo: T_Mode_Id, ixAmt: T_Setl_Amt, ixTips: T_Tips_Amt, ixRevId: T_Rev_Id, ixExtrAmt: "", ixPartyTyId: "", ixPartyId: T_Party_Id,
                                    ixRoomNo: "", ixChqNo: T_Cheque_No, ixBankNm: T_Bank_Nm, ixVouchNo: "", ixNarr: T_Narr, ixTrnsRoom: "", ixTrnsReg: "", ixcurid: "", ixcashcard: "",
                                    ixFornAmt: "", ixConvRate: "", ixCCInd: "", ixPartyNm: T_Party_Nm, ixSetlModeId: T_Mode_Id, ixCurno: "", ixcashcardnm: "", ixNarr1: vDate,
                                };

                                break;
                            case Md_ToRoom:
                                if (value.ROOM_NO) T_Room_No = value.ROOM_NO.toString().trim();
                                if (value.TRNSF_ROOM_NO) T_Trns_RoomNo = value.TRNSF_ROOM_NO.toString().trim();
                                if (value.TRNSF_ROOM_REG_NO) T_Trns_RegNo = value.TRNSF_ROOM_REG_NO.toString().trim();
                                T_Party_Nm = fnGetGuestNm(T_Trns_RegNo);                               

                                set = {
                                    ixModeCombo: T_Mode_Id, ixAmt: T_Setl_Amt, ixTips: T_Tips_Amt, ixRevId: T_Rev_Id, ixExtrAmt: "", ixPartyTyId: "", ixPartyId: "",
                                    ixRoomNo: T_Room_No, ixChqNo: "", ixBankNm: "", ixVouchNo: "", ixNarr: "", ixTrnsRoom: T_Trns_RoomNo, ixTrnsReg: T_Trns_RoomNo, ixcurid: "", ixcashcard: "",
                                    ixFornAmt: "", ixConvRate: "", ixCCInd: "", ixPartyNm: T_Party_Nm, ixSetlModeId: T_Mode_Id, ixCurno: "", ixcashcardnm: "", ixNarr1: "",
                                };
                                break;
                            case Md_Chq:
                                if (value.CC_CHQ_NO) T_Cheque_No = value.CC_CHQ_NO.toString().trim();
                                if (value.BANK_NM) T_Bank_Nm = value.BANK_NM.toString().trim();
                                if (value.CURRENCY_ID) T_Cur_Id = value.CURRENCY_ID.toString().trim();
                                if (value.EXTRA_AMT) T_Extr_Amt = value.EXTRA_AMT.toString().trim();
                                if (T_Extr_Amt == "") T_Extr_Amt=0;
                                if (value.FORN_AMT) T_Forn_Amt = value.FORN_AMT.toString().trim();
                                if (T_Forn_Amt == "") T_Forn_Amt=0;
                                if (value.CONV_RATE) T_Conv_Rate = value.CONV_RATE.toString().trim();
                                if (T_Conv_Rate == "") T_Conv_Rate=0;
                                if (T_Cur_Id == "") T_Cur_Id = window.BASE_CURRENCY;
                                if (value.NARRATION) T_Narr = value.NARRATION.toString().trim();
                                debugger;
                                var vDate = "";
                                if (T_Narr.length >= 10) {
                                ...
                                set = {
                                    ixModeCombo: T_Mode_Id, ixAmt: T_Setl_Amt, ixTips: T_Tips_Amt, ixRevId: T_Rev_Id, ixExtrAmt: T_Extr_Amt, ixPartyTyId: "", ixPartyId: "",
                                    ixRoomNo: "", ixChqNo: T_Cheque_No, ixBankNm: T_Bank_Nm, ixVouchNo: "", ixNarr: T_Narr, ixTrnsRoom: "", ixTrnsReg: "", ixcurid: T_Cur_Id, ixcashcard: "",
                                    ixFornAmt: T_Forn_Amt, ixConvRate: T_Conv_Rate, ixCCInd: "", ixPartyNm: "", ixSetlModeId: T_Mode_Id, ixCurno: "", ixcashcardnm: "", ixNarr1: vDate,
                                };
                            ...
                            case Md_Forn:                              
                                ...
                                set = {
                                    ixModeCombo: T_Mode_Id, ixAmt: T_Setl_Amt, ixTips: T_Tips_Amt, ixRevId: T_Rev_Id, ixExtrAmt: T_Extr_Amt, ixPartyTyId: "", ixPartyId: "",
                                    ixRoomNo: "", ixChqNo: "", ixBankNm: T_Bank_Nm, ixVouchNo: T_VouchNo, ixNarr: T_Narr, ixTrnsRoom: "", ixTrnsReg: "", ixcurid: T_Cur_Id, ixcashcard: "",
                                    ixFornAmt: T_Forn_Amt, ixConvRate: T_Conv_Rate, ixCCInd: "", ixPartyNm: "", ixSetlModeId: T_Mode_Id, ixCurno: "", ixcashcardnm: "", ixNarr1: "",
                                };
                                break;
                            case Md_Mem:                                
                                if (value.PARTY_ID) T_Party_Id = value.PARTY_ID.toString().trim();
                                ...
                                set = {
                                    ixModeCombo: T_Mode_Id, ixAmt: T_Setl_Amt, ixTips: T_Tips_Amt, ixRevId: T_Rev_Id, ixExtrAmt: "", ixPartyTyId: "L", ixPartyId: T_Party_Id,
                                    ixRoomNo: "", ixChqNo: "", ixBankNm: "", ixVouchNo: "", ixNarr: T_Narr, ixTrnsRoom: "", ixTrnsReg: "", ixcurid: "", ixcashcard: "",
                                    ixFornAmt: "", ixConvRate: "", ixCCInd: "", ixPartyNm: T_Party_Nm, ixSetlModeId: T_Mode_Id, ixCurno: "", ixcashcardnm: "", ixNarr1: "",
                                };
                                break;
                            ...
                            case Md_CCoupon:
                                ...
                                if (value.PARTY_ID) T_Party_Id = value.PARTY_ID.toString().trim();
                                if (value.CC_CHQ_NO) T_Cheque_No = value.CC_CHQ_NO.toString().trim();
                                if (value.BANK_NM) T_Party_Nm = value.BANK_NM.toString().trim();
                                set = {
                                    ixModeCombo: T_Mode_Id, ixAmt: T_Setl_Amt, ixTips: T_Tips_Amt, ixRevId: T_Rev_Id, ixExtrAmt: "", ixPartyTyId: "", ixPartyId: T_Party_Id,
                                    ixRoomNo: "", ixChqNo: T_Cheque_No, ixBankNm: T_Party_Nm, ixVouchNo: "", ixNarr: "", ixTrnsRoom: "", ixTrnsReg: "", ixcurid: "", ixcashcard: "",
                                    ixFornAmt: "", ixConvRate: "", ixCCInd: "", ixPartyNm: "", ixSetlModeId: T_Mode_Id, ixCurno: "", ixcashcardnm: "", ixNarr1: "",
                                };
                                break;
                            case Md_FundsTransf:
                                ...
                                set = {
                                    ixModeCombo: T_Mode_Id, ixAmt: T_Setl_Amt, ixTips: T_Tips_Amt, ixRevId: T_Rev_Id, ixExtrAmt: "", ixPartyTyId: "", ixPartyId: "",
                                    ixRoomNo: "", ixChqNo: T_Cheque_No, ixBankNm: T_Bank_Nm, ixVouchNo: "", ixNarr: T_Narr, ixTrnsRoom: "", ixTrnsReg: "", ixcurid: "", ixcashcard: "",
                                    ixFornAmt: "", ixConvRate: "", ixCCInd: "", ixPartyNm: "", ixSetlModeId: T_Mode_Id, ixCurno: "", ixcashcardnm: "", ixNarr1: vDate,
                                };
                                break;
                            case Md_PayBill:
                                ...
                                if (T_Narr != "") {
                                    if (T_Narr.length >= 10) {
                                        vDate = T_Narr.substring(0, 10);
                                        if (isValidDate(vDate) == true) {
                                            vDate = formatDate1(vDate);
                                            vDate = new Date(vDate);
                                            if (T_Narr.length > 10) vDepset = T_Narr.substring(10, T_Narr.length);
                                        }
                                        else {
                                            vDepset = T_Narr.substring(0, T_Narr.length);
                                        }

                                    }
                                    else vDepset = T_Narr.substring(0, T_Narr.length);
                                }
                                

                                set = {
                                    ixModeCombo: T_Mode_Id, ixAmt: T_Setl_Amt, ixTips: T_Tips_Amt, ixRevId: T_Rev_Id, ixExtrAmt: "", ixPartyTyId: "", ixPartyId: T_Party_Id,
                                    ixRoomNo: "", ixChqNo: T_Cheque_No, ixBankNm: T_Bank_Nm, ixVouchNo: vDepset, ixNarr: T_Narr, ixTrnsRoom: "", ixTrnsReg: "", ixcurid: "", ixcashcard: "",
                                    ixFornAmt: "", ixConvRate: "", ixCCInd: "", ixPartyNm: T_Party_Nm, ixSetlModeId: T_Mode_Id, ixCurno: "", ixcashcardnm: "", ixNarr1: vDate,
                                };
                            ...
                            case Md_Pay:
                                ...
                                T_VouchNo = fnGetTNPM(T_Party_Id);
                            ...
                            default:
                                set = {
                                    ixModeCombo: "", ixAmt: "", ixTips: "", ixRevId: "", ixExtrAmt: "", ixPartyTyId: "", ixPartyId: "",
                                    ixRoomNo: "", ixChqNo: "", ixBankNm: "", ixVouchNo: "", ixNarr: "", ixTrnsRoom: "", ixTrnsReg: "", ixcurid: "", ixcashcard: "",
                                    ixFornAmt: "", ixConvRate: "", ixCCInd: "", ixPartyNm: "", ixSetlModeId: "", ixCurno: "", ixcashcardnm: "", ixNarr1: "",
                                };
                                break;
                        }                     
...
var fnSettleModeChange = function (RowId) {
    ...
    if (SettleMode == "V") {
        ...
        var set = {};
        set = {
            ixModeCombo: "V", ixAmt: "", ixTips: "", ixRevId: "", ixExtrAmt: "", ixPartyTyId: "", ixPartyId: "",
            ixRoomNo: "", ixChqNo: "", ixBankNm: "", ixVouchNo: "", ixNarr: "", ixTrnsRoom: "", ixTrnsReg: "", ixcurid: "",
...
var fnIsRoomGuestChkdOut = function (BILL_NO,OUTLET_ID) {
    debugger;
    CompId = $$("Property").getValue();
    Request = {
        REQ_NM: "FNISROOMGUESTCHKDOUT",
        COMPID: CompId,
        BILL_NO: BILL_NO,
        OUTLET_ID: OUTLET_ID,
    }
...
var fnCheckTempFolioSettlement = function (BILL_NO) {
    debugger;
    CompId = $$("Property").getValue();
    Request = {
        REQ_NM: "FNCHECKTEMPFOLIOSETTLEMENT",
        COMPID: CompId,
        BILL_NO: BILL_NO,
...
var fnGetGuestNm = function (Reg_No) {
    debugger;
    CompId = $$("Property").getValue();
    Request = {
        REQ_NM: "FNGETGUESTNM",
...
var fnGetTNPM = function (PARTY_ID) {
    debugger;
    CompId = $$("Property").getValue();
    Request = {
        REQ_NM: "FNGETTNPM",
...
var fnCreateSettle = function () {
    ...
    var gridSettle = $$("gridSettle").serialize();
    if (fnIsRoomGuestChkdOut(window.Ret_Original_Bill_No, window.BN_OUTLET_ID) == false) {
        return false;
    }
    debugger;
...
var fnSave = function () {
    ...
    var txtLessAdv = "";
    var txtReason = $$("txtReason").getValue();
    if ($$("txtLessAdv").isVisible == true) txtLessAdv = $$("txtLessAdv").getValue();    
    CompId = $$("Property").getValue();
    var txtSetlNo = $$("txtSetlNo").getValue();  
    var bSuc = 0;
    $("#loading").show();
    Request = {
        REQ_NM: "FNSAVERESETTLE",
        COMPID: CompId,
        Ret_GSNo: Ret_GSNo,
        SETLE_DT: SETLE_DT,
        txtSetlNo:txtSetlNo,
