    ...
    data: "request=" + dataparam,
        ...
        success: function (d) {
            ...
            $.each(ddlgrid, function (key, value) {
                if (key == "ddltitle")
                    $("#" + key).kendoDropDownList({ dataTextField: "ITEM_NM", dataValueField: "ITEM_VAL", dataSource: value, height: 100, optionLabel: "ALL" });
                    // $("#" + key).jqxDropDownList({ width: '30%', source: value, displayMember: "ITEM_NM", valueMember: "ITEM_VAL", height: 25});
                else
                    $("#" + key).kendoDropDownList({ dataTextField: "ITEM_NM", dataValueField: "ITEM_VAL", dataSource: value, height: 200, optionLabel: "All", filter: "startswith" });
