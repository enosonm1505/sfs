                               ...
                               rows: [
                                   {
                                       ...
                                       on: {
                                           onChange: function (newval, oldval) {
                                               ...
                                               fnLoadGLTrnTyInd();
                                               var Options = $$("grdGLTransDet").getColumnConfig("Drcr").collection;
                                               Options.clearAll();
                                               if (newval == "0")
                                               {
                                                   var data = [{ value: "DR", id: "DR" }, ]
                                                   Options.parse(data);
                                               }
                                               else
                                               {
                                                   var data = [{ value: "DR", id: "DR" }, { value: "CR", id: "CR" }, ]
                                                   Options.parse(data);
                                               }
                                               ...
                                               cols: [
                                                   {
                                                       ...
                                                       on: {
                                                           onChange: function (newval, oldval) {
                                                               if ($("#hdnMULTI_CURRENCY_IND").val() == "1") CurSalePurRate = fnLoadCurSalePurRate();                                                                  
                                                               if (!fnGLTrnDtCheck()) {
                                                                   return false;
                                                               }
                                                           },
                                              ...
                                              on: {
                                                  'onKeyPress': function (e, id) {
                                                      ...
                                                      if(charCode==9)
                                                      {
                                                          ...
                                                          $$("grdGLTransDet").editCell(itemval.id, "Drcr", true, false);
                                              ...
                                              rows: [
                                                    ...
                                                    cols: [
                                                            ...
                                                            cols: [
                                                      {
                                                          ...
                                                          inputWidth: 180,
                                                          width: 180,
                                                          format: "1111111.0000000",
                                                          attributes: { maxlength: 7 },
                                                          inputAlign: "right",
                                                          hidden: true,
                                                          on: {
                                                              "onKeyPress": function (code, e) {
                                                                  return fnFloatText(code, e, this.getValue());
                                                              },
                                                              onChange: function (newval, oldval) {
                                                                  debugger;
                                                                  if ($$("TxtFornAmt").getValue() != "" && $("#hdnEditCur").val() != "1")//&& newval != "" 
                                                                  {
                                                                      var CurRows = $$("grdGLTransDet").getSelectedItem();
                                                                      if (CurRows.Drcr == "CR") CurRows.Credit = parseFloat(newval * $$("TxtFornAmt").getValue());
                                                                      else CurRows.Debit = parseFloat(newval * $$("TxtFornAmt").getValue());
                                                                      CurRows.PsRate = newval;
                                                                      CurRows.FornAmt = $$("TxtFornAmt").getValue();
                                                                      CurRows.RateTy = ($$("BtnSalePur").config.label == "S" ? "0" : "1");
                                                                      if (CurRows.AnaAppl == "1") {
                                                                          var dsGlAna = $$("grdGlAnaly").serialize();

                                                                          if (dsGlAna.length == 1) {
                                                                              var id = $$("grdGlAnaly").getFirstId();
                                                                              var getval1 = $$("grdGlAnaly").getItem(id);
                                                                              if (parseFloat(CurRows.Credit) > 0) getval1.Amount = parseFloat(CurRows.Credit);
                                                                              else getval1.Amount = parseFloat(CurRows.Debit);
                                                      ...
                                                      },
                                                       {
                                                           ...
                                                           click: function () {
                                                               debugger;
                                                               var btn = $$("BtnSalePur").config.label;
                                                               if (btn == "S")
                                                               {
                                                                   $$("TxtSalePurRate").define("label", "Sale Rate");
                                                                   $$("TxtSalePurRate").refresh();
                                                                   $$("BtnSalePur").define("label", "P");
                                                                   $$("BtnSalePur").refresh();
                                                               }
                                                               else {
                                                                   $$("TxtSalePurRate").define("label", "Purchase Rate");
                                                                   $$("TxtSalePurRate").refresh();
                                                                   $$("BtnSalePur").define("label", "S");
                                                                   $$("BtnSalePur").refresh();
                                                               }
                                                               if (CurSalePurRate == "[]" || CurSalePurRate.length == 0) CurSalePurRate = fnLoadCurSalePurRate();
                                                               ...
                                                               if (DtFilter.length > 0) {
                                                                   if ($$("BtnSalePur").config.label == "P")
                                                                       $$("TxtSalePurRate").setValue(DtFilter[0].SALE_CONV_RATE);
                                                                   else
                                                                       $$("TxtSalePurRate").setValue(DtFilter[0].PUR_CONV_RATE);
                                                               }
                                                           }
                                                       },
                                                    ...
                                                    },
                                                     {
                                                         ...
                                                         width: 250,
                                                         hidden:true,
                                                         format: "1111111111.00", attributes: { maxlength:10 }, inputAlign: "right",
                                                         on: {
                                                             "onKeyPress": function (code, e) {
                                                                 return fnFloatText(code, e, this.getValue());
                                                             },
                                                             onChange: function (newval, oldval) {
                                                                 debugger;
                                                                 if ($$("TxtSalePurRate").getValue() != "" && $("#hdnEditCur").val() != "1")// && newval != ""
                                                                 {                                                                   
                                                                     var CurRows = $$("grdGLTransDet").getSelectedItem();
                                                                     if (CurRows.Drcr == "CR") CurRows.Credit = parseFloat(newval * $$("TxtSalePurRate").getValue());
                                                                     else CurRows.Debit = parseFloat(newval * $$("TxtSalePurRate").getValue());
                                                                     CurRows.PsRate = $$("TxtSalePurRate").getValue();
                                                                     CurRows.FornAmt = newval;
                                                                     CurRows.RateTy = ($$("BtnSalePur").config.label == "S" ? "0" : "1");
                                                                     if (CurRows.AnaAppl == "1") {
                                                                         var dsGlAna = $$("grdGlAnaly").serialize();
                       ...
                       cols: [
                           {
                                   ...
                                   $change: function (item) {
                                      // debugger;
                                       ...
                                       if ($("#hdnGSTAppl").val() == "1" || $("#hdnInGstInd").val() == "1" || $("#hdnK_TAX").val() == "4" || $("#hdnK_TAX").val() == "3" || $("#hdnK_TAX").val() == "2" || $("#hdnM_TAX").val() == "4") {
                                           ...
                                           var TaxCaption = fnLoadTaxCap($.trim(item.hdnAcId), TaxDet);
                                           item.btnGST = $.trim(TaxCaption);
                               ...
                               columns: [
                                       {
                                           header: "D/C", id: "Drcr", width: 50, editor: 'combo', liveEdit: true,
                                           //footer: [{ text: "Total", colspan: 4 },
                                           //  { text: "Debit/Credit Difference : 0.00", content: 'Diff', colspan: 4, css: "leftfooter" }],
                                           collection: function (id) { return [{ value: "DR", id: "DR" }, { value: "CR", id: "CR" }, ] }, css: { 'text-align': 'center ! important' }
                                       },
                                       { header: "AC CD", id: "ACCD", width: 80, css: { 'text-align': 'left ! important' },   },
                                       ...
                                       { header: "Currency", id: "CurrId", hidden: true, width: 80, css: { 'text-align': 'center ! important' }, editor: "select", liveEdit: true, collection: function (id) { return ddlcurrency; } },
                                       ...
                                       { header: "FCurBal", id: "FCurBal", hidden: true },
                                        {
                                            header: "Debit", id: "Debit", width: 110, editor: 'text', liveEdit: true, css: { 'text-align': 'right ! important' },
                                            //footer: [{ content: "summColumn" }, {text:""}],
                                       ...
                                       {
                                           header: "Credit", id: "Credit", width: 110, editor: 'text', liveEdit: true, css: { 'text-align': 'right ! important' },
                                           footer: { content: "summColumn" },
                                           //footer: [{ content: "summColumn" }, { text: "" }],
...

                                       {
                                           ...
                                           footer: { text: "Difference : 0.00", content: 'Diff' }
                                       },

                                     
                                       { header: "Doc No", id: "DocNo", width: 80, editor: 'text', liveEdit: true, hidden: true, css: { 'text-align': 'left ! important' } },
                                       { header: "Doc Dt", id: "DocDt", hidden: true, width: 80, stringResult: true, editor: 'date', format: webix.Date.dateToStr("%d/%m/%Y"), liveEdit: true, css: { 'text-align': 'left ! important' } },
                               ...
                               on: {
                                   ...
                                   'onBeforeEditStart': function (id) {
                                    //   debugger;
                                       ...
                                       if (id.column == "Credit") {
                                           if (getval.Drcr == "DR" ||( $("#hdnMULTI_CURRENCY_IND").val() == "1" && getval.CurrId != $("#hdnBaseCurrId").val()) ) return false;
                                           else return true;
                                       }
                                       if (id.column == "Debit" ) {
                                           $$('PopupAccNmSrch').hide();
                                           if (getval.Drcr == "CR" || ($("#hdnMULTI_CURRENCY_IND").val() == "1" && getval.CurrId != $("#hdnBaseCurrId").val()) ) return false;
                                           else return true;
                                       }
                                   ...
                                   'onItemClick': function (id, e, node, trg) {
                                       ...
                                       if ($("#hdnMULTI_CURRENCY_IND").val() == "1" && getval.CurrId != "" && getval.CurrId != $("#hdnBaseCurrId").val() ) {
                                           debugger;
                                           $("#hdnEditCur").val("1");
                                           $$("TxtSalePurRate").setValue("");
                                           $$("TxtFornAmt").setValue("");
                                           ...
                                           if(getval.FornAmt!=undefined) $$("TxtFornAmt").setValue(getval.FornAmt);
                                           $$("BtnSalePur").define("label", getval.RateTy =="1" ? "P" : "S")
                                           $$("BtnSalePur").refresh();
                                           $("#hdnEditCur").val("");
                                       }
                                   ...
                                   'onEditorChange': function (id, value, row) {
                                       ...
                                       if (id.column == 'CurrId' && $("#hdnMULTI_CURRENCY_IND").val() == "1" && getval.CurrId != $.trim($("#hdnBaseCurrId").val())) {
                                           debugger;
                                           $("#hdnEditCur").val("1");
                                            $$("TxtSalePurRate").setValue("");
                                            $$("TxtFornAmt").setValue("");
                                       ...
                                       if (id.column == 'Drcr') {
                                           debugger;
                                            ...
                                            //$$("grdGLTransDet").updateItem(row, getval);
                                            //$$("grdGLTransDet").refresh();
                                           getval.Credit = "";
                                           getval.Debit = "";
                                           fnDeleteRowBillDetData();
                                        ...
                                        if ($.trim($("#hdnGridClickCol").val()) == "Credit") {
                                           ...
                                           if ((charCode > 31 && (charCode < 48 || (charCode > 57 && (charCode < 96 || charCode > 105)))) || charCode == 13) {
                                               if ((e == 66 || e == 13) && $("#hdnBillDetInd").val() == "1" ) {
                                                   ...
                                                   if (Debit != 0 || Credit != 0) {
                                                       $$("grdGLTransDet").refresh();
                                                       fnCallBillDetails(ddlRefTy, itemval.CurrId, itemval.FornAmt,itemval.PsRate);
                                                       return false;
                                                   }
                                                   else
                                                       return false;
                                   ...
                                   'onAfterEditStop': function (state, editor) {
                                       ...
                                       if (editor.column == 'Drcr' && ($("#hdnTrnNewRowAdd").val() != "1" || ($("#hdnTrnNewRowAdd").val() == "1" && $("#hdnCurrDC").val() != getval.Drcr))) {
                                           debugger;
                   ...
                   rows: [
                       ...
                       },
                       {
                           cols: [{
                               ...
                               scroll: "y",
                               columns: [
                                       { header: ["Chq Dt", { content: "textFilter" }], id: "ChqDt", width: 125, css: { 'text-align': 'center ! important' } },
                                       { header: ["Chq No", { content: "textFilter" }], id: "ChqNo", width: 90, css: { 'text-align': 'left ! important' } },
                                       ...
                                       { header: ["Ledger", { content: "textFilter" }], id: "LedgerNm", width: 200, css: { 'text-align': 'left ! important' } },
...
function gridResizetr(choice) {
    ...
    $$("grdanalcol").define("width", vWidth1 - 275);//500

    $$("GlTransaction").define("height", vheight - 50);//100
    $$("GlTransaction").resize();
    
    //$$("GlTransaction").define("width", vWidth);
    
    //vheight = $$("GlTransaction").$height;
    var offsetTop = $$("grdGLTransDet").getNode().offsetTop;

    $$("grdGLTransDet").define("height", ((vheight - offsetTop-220)));//190
    $$("grdGLTransDet").resize();

      
    $$("grdGlAnaly").define("height", ((130)));//100
    $$("grdGlAnaly").resize();

    $$("GlTransaction").resize();
}
webix.ui.datafilter.Diff = webix.extend({
    refresh: function (master, node, value) {
       // debugger;
        if ($("#hdnDefGlTrnTy").val() != "0") {
            ...
            var retVal = (parseFloat(DrAmt).toFixed(2) - parseFloat(CrAmt).toFixed(2));
            if (retVal < 0) {
                retVal = retVal * (-1);
                retVal = "Difference :" + " (" + retVal.toFixed(2) + ")";
            ...
            node.firstChild.innerHTML = retVal;
        }
