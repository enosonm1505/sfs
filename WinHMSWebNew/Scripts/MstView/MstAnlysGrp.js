...
var AnlysGrpLoad = function (Request, AnlysGrpID, Glurl) {
    //debugger;
    ...
    data: "request=" + dataparam,
        success: function (d) {
            ...
            $("#txtAnlysGrpNm").val(Detemp.AnlysGrp[0].G_NM);
            $("#txtSeqNo").val(Detemp.AnlysGrp[0].S_SEQ);
            if (Detemp.AnlysGrp[0].A_IND == "" || Detemp.AnlysGrp[0].A_IND == null)
...
var AnlysGrpSave = function (Request, Glurl) {
    var reqobj = {};
    reqobj["COMPID"] = Request.COMPID;
    reqobj["USER_ID"] = Request.USER_ID;
    reqobj["REQ_NM"] = Request.REQ_NM;
    ...
    reqobj["AnlysGrpNm"] = $("#txtAnlysGrpNm").val().trim();
    reqobj["SeqNo"] = $("#txtSeqNo").val().trim();
    if (Request.Mode == "OPEN")
        reqobj["AnlysGrpID"] = $("#ddlAnlysGrp").val().trim();
    else
        reqobj["AnlysGrpID"] = $("#txtAnlysGrp").val().trim();
